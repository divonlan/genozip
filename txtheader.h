...
extern bool txtheader_zip_read_and_compress (uint32_t *vcf_line_i);
...
extern void txtheader_piz_read_and_reconstruct (uint32_t component_i, ConstSecLiEntP txt_header_sl);
