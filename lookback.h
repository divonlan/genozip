...
extern void lookback_insert (VBlockP vb, Did lb_did_i, Did did_i, bool copy_last_value, ValueType value, bool is_word_index);

extern void lookback_insert_txt (VBlockP vb, Did lb_did_i, Did did_i, STRp(txt));
