...
extern bool sorter_piz_is_txtheader_in_plan (uint32_t component_i);
extern bool sorter_piz_is_component_no_read (uint32_t component_i);
extern bool sorter_piz_is_vb_no_read (uint32_t vb_i);
extern bool sorter_piz_is_liftover_rejects (uint32_t component_i);
extern void sorter_piz_remove_vb_from_recon_plan (uint32_t vb_i);
