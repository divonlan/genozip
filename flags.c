...
void flags_update_piz_one_file (int z_file_i /* -1 if unknown */)
{
    ...
    flag.data_modified = flag.data_modified_by_txtheader || flag.data_modified_by_reconstruction || flag.data_modified_by_writer;
