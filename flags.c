...
void flags_update (unsigned num_txt_files, const char **filenames)
{
    ...
    if (flag.show_sex) {
        ...
        flag.no_header = true; // don't show SAM/BAM header
    ...
    flag.genocat_analysis = flag.list_chroms || flag.show_sex;
