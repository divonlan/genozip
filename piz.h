...
extern bool piz_one_file (uint32_t component_i, bool is_last_file);
...
extern int32_t piz_reconstruct_from_ctx_do (VBlockP vb, DidIType did_i, char sep, bool reconstruct);
#define piz_reconstruct_from_ctx(vb,did_i,sep,reconstruct) piz_reconstruct_from_ctx_do ((VBlockP)(vb),(did_i),(sep),(reconstruct))
