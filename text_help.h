...
static const char *help_genozip[] = {
    ...
    "",    
    "Flags:",    
    "   -i --input-type   <data-type>. data-type is one of: ",
...
static const char *help_genocat[] = {
    ...
    "   VCF SAM           Show one or more regions of the file. Examples:",
    ...
    "   VCF",
    "",
    "   -H --no-header    Don't output the header",
    "   VCF SAM 23andMe",
    "",
    "   -1 --header-one   Don't output the VCF header, except for the last line (with the field and sample names)",
    "   VCF",
    "",
    "   --header-only     VCF SAM 23andMe: Output only the header of the file",
    "                     FASTQ FASTA: Output the header (description) of each record",
    "",
