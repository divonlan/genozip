...
static const char *help_genozip[] = {
    ...
    "   VCF/BCF, SAM/BAM/CRAM, FASTQ, FASTA, GVF, Phylip and 23andMe",
    "",
...
static const char *help_genozip_developer[] = {
    ...
    "",
    "   ZUC  -w --show-stats   Show the internal structure of a genozip file and the associated compression statistics",
    "",
    "   ZUC  -W --SHOW-STATS   Show more detailed statistics",
    "",
    ...
    "",
    "   ZUC  --show-headers    <section-type>. Show all the sections headers, or those of a specific section type if the optional argument is provided. Argument is a case-insesitive substring of a section name.",
    "",
    ...
    "                          Note: the sequence stored in a .ref.genozip is NOT 100% identical to the FASTA that was used to generate it",
    "",
    ...
    "",
    "   Z    --show-hash       See raw numbers that feed into determining the size of the global hash tables",
    "",
    "   ZUC  --show-aliases    See contents of SEC_DICT_ID_ALIASES section",
    "",
    "   ZUC  --show-containers Show flow of containers",
    "",
    "   Z    --seg-only        Run the segmenter but don't compress and don't write the output",
    "",
    "   ZUC  --xthreads        Use only one thread for the main PIZ/ZIP dispatcher. This doesn't affect thread use of other dispatchers",
    "",
    "   ZUCL --debug-memory    Show Buffer allocations and destructions",
    "",
...
static const char *help_genocat[] = {
    ...
    "   FASTA ref                   genocat myfile.sam.genozip -r22:1000+151   (151 bases, starting pos 1000, on contig 22)",
    ...
    "",
    "   --show-sex        (SAM and BAM only) Determine whether a SAM/BAM is a Male or a Female. See http://genozip.com/sex-assignment.html",
    "",
    "   --show-coverage   (SAM and BAM only) Shows the coverage and depth of each contig. See http://genozip.com/coverage.html",
    "",
    "   --show-coverage-chrom (SAM and BAM only) Same as --show-coverage but shows only contigs that are chromosomes",
    "",
