...
static const char *help_genozip[] = {
    ...
    "",
    "   -m --md5          Shows the MD5 hash of the VCF file. genozip always calculates and stores the md5, and when the resulting file is decompressed, this MD5 will be compared to the MD5 of the decompressed VCF. "
