...
static const char *help_genozip[] = {
    ...
    "                     1. SAM/BAM files",
    "                     2. VCF files with significant REFALT content (see \"% of zip\" in --show-stats)",
    "",
    ...
    "                     Note: Compression ratio is usally worse with --REFERENCE than without any reference at all",  
...
static const char *help_genozip_developer[] = {
    ...
    "",
    "   Z    --dump-one-b250   <field-name>. Dump the binary content of the b250 data of this field, exactly as they appear in the genozip format, to stdout - specify the field name as it appears in the \"Name\" column in --show-stats, for fields that have \"comp b250\" data",
    "",
    "   Z    --dump-one-local  <field-name>. Dump the binary content of the local data of this field, exactly as they appear in the genozip format, to stdout - specify the field name as it appears in the \"Name\" column in --show-stats, for fields that have \"comp local\" data",
    "",
