...
static const char *help_genocat[] = {
    ...
    "",
    "   --show-coverage   (SAM, BAM, FASTQ) Shows the coverage and depth of each contig. See http://genozip.com/coverage.html",
    "",
    "   --show-coverage-chrom (SAM, BAM, FASTQ) Same as --show-coverage but shows only contigs that are chromosomes",
    "",
