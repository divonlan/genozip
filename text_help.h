...
static const char *help_genozip[] = {
    ...
    "",
    "   SAM optimizations: ",
    "   --optimize-SEQ    - SEQ and E2 data are compressed a bit better, but a bit slower. This is a lossless optimization",
    ...
    "   --optimize-SEQ    - Sequence data is compressed a bit better, but a bit slower. This is a lossless optimization",
...
static const char *help_genozip_developer[] = {
    ...
    "",
    "   ZUC  --show-ref-seq    Show the reference sequences. Combine with --regions to see specific regions (UC only). Combine with --sequential to omit newlines. '-' appears in unset loci. When used with genocat, only this is shown, not the file contents",
    "",
