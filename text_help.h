...
static const char *help_genozip[] = {
    ...
    "                     - PL data: Phred values of over 60 are changed to 60",    
    "                     Note: due to these data modifications, decompressed files will NOT be the same as the original VCF. For this reason, it is not possible to use this option in combination with --test or --md5",    
    "",
