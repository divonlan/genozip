...
static const char *help_genozip[] = {
    ...
    "                       Note: this follows Illumina's quality bins: https://sapac.illumina.com/content/dam/illumina-marketing/documents/products/technotes/technote_understanding_quality_scores.pdf",
