...
static const char *help_genounzip[] = {
    ...
    "",
    "   -z --bgzf         <level>. Compress the output to the BGZF format (.gz extension) using libdeflate, at the compression level specified in the argument. Argument specifies the compression level from 0 (no compression) to 12 (best, yet slowest, compression). If you're not sure what value to choose, 6 is a popular option.",
