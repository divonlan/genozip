...
static const char *help_genozip[] = {
    ...
    "   -z --compress     This is the default action of genozip",
    "",
    ...
    "                     Note: For this to work, gtshark needs to be installed and in the execution path - it is a separate software package that is not affliated with genozip in any way. It can be found here: https://github.com/refresh-bio/GTShark",
