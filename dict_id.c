...
DictId dict_id_make (rom str, unsigned str_len, DictIdType dict_id_type) 
{ 
...
{ 
    ...
    zfile_get_global_section (SectionHeader, sl, &dict_id_aliases_buf, "dict_id_aliases_buf");

    dict_id_aliases = B1ST (DictIdAlias, dict_id_aliases_buf);
