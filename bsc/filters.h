...
extern "C" {
    ...
    */
    int bsc_detect_contextsorder(void *vb, const unsigned char * input, int n, int features);
    ...
    */
    int bsc_reverse_block(void *vb, unsigned char * T, int n, int features);
    ...
    */
    int bsc_detect_recordsize(void *vb, const unsigned char * input, int n, int features);
