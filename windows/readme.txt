...
Actions - use at most one of these actions:
   ...
   -t --test         Test genozip. Compress the .vcf file(s), uncompress, and then compare the result to the original
                     .vcf - all in memory without writing to any file
...
Flags:
   ...
   -m --md5          Records the MD5 hash of the VCF file in the genozip file header. When the resulting file is
                     decompressed, this MD5 will be compared to the MD5 of the decompressed VCF
