...
extern LiftOverStatus liftover_seg_add_chain_data (VBlockP vb, DidIType ochrom_did, char oref_special, DictId liftover_dict_id, DictId liftback_dict_id, DictId liftrejd_dict_id);
