...
#define _FASTQ_QmatNAME ((uint64_t)4993719367039544785)
...
#define _KRAKEN_QmatNAME ((uint64_t)4993719367039544785)
...
#define _SAM_QmatNAME ((uint64_t)4993719367039544785)
...
#define _FORMAT_DS_0 ((uint64_t)811553604)
#define _FORMAT_DS_1 ((uint64_t)828330820)
#define _FORMAT_DS_2 ((uint64_t)845108036)
#define _FORMAT_GL ((uint64_t)19527)
#define _FORMAT_GL_0 ((uint64_t)811551815)
#define _FORMAT_GL_1 ((uint64_t)828329031)
#define _FORMAT_GL_2 ((uint64_t)845106247)
#define _FORMAT_GP ((uint64_t)20551)
#define _FORMAT_GP_0 ((uint64_t)811552839)
#define _FORMAT_GP_1 ((uint64_t)828330055)
#define _FORMAT_GP_2 ((uint64_t)845107271)
#define _FORMAT_GQ ((uint64_t)20807)
#define _FORMAT_GT ((uint64_t)21575)
#define _FORMAT_PL ((uint64_t)19536)
#define _FORMAT_PL_0 ((uint64_t)811551824)
#define _FORMAT_PL_1 ((uint64_t)828329040)
#define _FORMAT_PL_2 ((uint64_t)845106256)
#define _FORMAT_PRI ((uint64_t)4805200)
#define _FORMAT_PRI_0 ((uint64_t)207757070928)
#define _FORMAT_PRI_1 ((uint64_t)212052038224)
#define _FORMAT_PRI_2 ((uint64_t)216347005520)
...
#define _FORMAT_PP_0 ((uint64_t)811552848)
#define _FORMAT_PP_1 ((uint64_t)828330064)
#define _FORMAT_PP_2 ((uint64_t)845107280)
...
#define _FORMAT_AB_HET ((uint64_t)92656543679041)
...
#define _FORMAT_RD_0 ((uint64_t)811549778)
#define _FORMAT_RD_1 ((uint64_t)828326994)
#define _FORMAT_RD_2 ((uint64_t)845104210)
#define _FORMAT_FREQ ((uint64_t)1363497542)
#define _FORMAT_FREQ_0 ((uint64_t)53185943523910)
#define _FORMAT_FREQ_1 ((uint64_t)54285455151686)
#define _FORMAT_FREQ_2 ((uint64_t)55384966779462)
#define _FORMAT_PVAL ((uint64_t)1279350352)
#define _FORMAT_PVAL_0 ((uint64_t)53185859376720)
#define _FORMAT_PVAL_1 ((uint64_t)54285371004496)
#define _FORMAT_PVAL_2 ((uint64_t)55384882632272)
...
typedef enum { FASTQ_CONTIG, FASTQ_DESC, FASTQ_Q0NAME, FASTQ_Q1NAME, FASTQ_Q2NAME, FASTQ_Q3NAME, FASTQ_Q4NAME, FASTQ_Q5NAME, FASTQ_Q6NAME, FASTQ_Q7NAME, FASTQ_QmatNAME, FASTQ_E1L, FASTQ_SQBITMAP, FASTQ_NONREF, FASTQ_NONREF_X, FASTQ_GPOS, FASTQ_STRAND, FASTQ_E2L, FASTQ_QUAL, FASTQ_DOMQRUNS, FASTQ_TOPLEVEL, FASTQ_TAXID, FASTQ_LINE3, NUM_FASTQ_FIELDS } FASTQFields;
...
#define FASTQ_PREDEFINED { \
    ...
    [FASTQ_QmatNAME] = { { _FASTQ_QmatNAME }, TAG(QmatNAME) }, \
...
#define KRAKEN_PREDEFINED { \
    ...
    [KRAKEN_QmatNAME] = { { _KRAKEN_QmatNAME }, TAG(QmatNAME) }, \
...
#define SAM_PREDEFINED { \
    ...
    [SAM_QmatNAME] = { { _SAM_QmatNAME }, TAG(QmatNAME) }, \
...
#define VCF_PREDEFINED { \
    ...
    [FORMAT_DS_0] = { { _FORMAT_DS_0 }, TAG(DS_0) }, \
    [FORMAT_DS_1] = { { _FORMAT_DS_1 }, TAG(DS_1) }, \
    [FORMAT_DS_2] = { { _FORMAT_DS_2 }, TAG(DS_2) }, \
    [FORMAT_GL] = { { _FORMAT_GL }, TAG(GL) }, \
    [FORMAT_GL_0] = { { _FORMAT_GL_0 }, TAG(GL_0) }, \
    [FORMAT_GL_1] = { { _FORMAT_GL_1 }, TAG(GL_1) }, \
    [FORMAT_GL_2] = { { _FORMAT_GL_2 }, TAG(GL_2) }, \
    [FORMAT_GP] = { { _FORMAT_GP }, TAG(GP) }, \
    [FORMAT_GP_0] = { { _FORMAT_GP_0 }, TAG(GP_0) }, \
    [FORMAT_GP_1] = { { _FORMAT_GP_1 }, TAG(GP_1) }, \
    [FORMAT_GP_2] = { { _FORMAT_GP_2 }, TAG(GP_2) }, \
    [FORMAT_GQ] = { { _FORMAT_GQ }, TAG(GQ) }, \
    [FORMAT_GT] = { { _FORMAT_GT }, TAG(GT) }, \
    [FORMAT_PL] = { { _FORMAT_PL }, TAG(PL) }, \
    [FORMAT_PL_0] = { { _FORMAT_PL_0 }, TAG(PL_0) }, \
    [FORMAT_PL_1] = { { _FORMAT_PL_1 }, TAG(PL_1) }, \
    [FORMAT_PL_2] = { { _FORMAT_PL_2 }, TAG(PL_2) }, \
    [FORMAT_PRI] = { { _FORMAT_PRI }, TAG(PRI) }, \
    [FORMAT_PRI_0] = { { _FORMAT_PRI_0 }, TAG(PRI_0) }, \
    [FORMAT_PRI_1] = { { _FORMAT_PRI_1 }, TAG(PRI_1) }, \
    [FORMAT_PRI_2] = { { _FORMAT_PRI_2 }, TAG(PRI_2) }, \
    [FORMAT_F1R2] = { { _FORMAT_F1R2 }, TAG(F1R2) }, \
    [FORMAT_F2R1] = { { _FORMAT_F2R1 }, TAG(F2R1) }, \
    [FORMAT_MB] = { { _FORMAT_MB }, TAG(MB) }, \
    [FORMAT_PP] = { { _FORMAT_PP }, TAG(PP) }, \
    [FORMAT_PP_0] = { { _FORMAT_PP_0 }, TAG(PP_0) }, \
    [FORMAT_PP_1] = { { _FORMAT_PP_1 }, TAG(PP_1) }, \
    [FORMAT_PP_2] = { { _FORMAT_PP_2 }, TAG(PP_2) }, \
    [FORMAT_SAC] = { { _FORMAT_SAC }, TAG(SAC) }, \
    [FORMAT_SB] = { { _FORMAT_SB }, TAG(SB) }, \
    [FORMAT_PS] = { { _FORMAT_PS }, TAG(PS) }, \
    [FORMAT_AB] = { { _FORMAT_AB }, TAG(AB) }, \
    [FORMAT_AB_HET] = { { _FORMAT_AB_HET }, TAG(AB_HET) }, \
    ...
    [FORMAT_RD_0] = { { _FORMAT_RD_0 }, TAG(RD_0) }, \
    [FORMAT_RD_1] = { { _FORMAT_RD_1 }, TAG(RD_1) }, \
    [FORMAT_RD_2] = { { _FORMAT_RD_2 }, TAG(RD_2) }, \
    [FORMAT_FREQ] = { { _FORMAT_FREQ }, TAG(FREQ) }, \
    [FORMAT_FREQ_0] = { { _FORMAT_FREQ_0 }, TAG(FREQ_0) }, \
    [FORMAT_FREQ_1] = { { _FORMAT_FREQ_1 }, TAG(FREQ_1) }, \
    [FORMAT_FREQ_2] = { { _FORMAT_FREQ_2 }, TAG(FREQ_2) }, \
    [FORMAT_PVAL] = { { _FORMAT_PVAL }, TAG(PVAL) }, \
    [FORMAT_PVAL_0] = { { _FORMAT_PVAL_0 }, TAG(PVAL_0) }, \
    [FORMAT_PVAL_1] = { { _FORMAT_PVAL_1 }, TAG(PVAL_1) }, \
    [FORMAT_PVAL_2] = { { _FORMAT_PVAL_2 }, TAG(PVAL_2) }, \
...
#define MAX_NUM_FIELDS_PER_DATA_TYPE 200
