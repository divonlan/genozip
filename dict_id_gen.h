...
#define _SAM_Q8NAME ((uint64_t)76198110443473)
#define _SAM_Q9NAME ((uint64_t)76198110443473)
...
#define _OPTION_NH_PRIM ((uint64_t)21754191091288142)
...
#define _OPTION_CR_CB ((uint64_t)25396804176532035)
...
#define _OPTION_UY_DOMQRUNS ((uint64_t)5858425845354934293)
#define _OPTION_UY_QUALMPLX ((uint64_t)6362548666810052885)
#define _OPTION_UY_DIVRQUAL ((uint64_t)5860948125029052949)
...
typedef enum { SAM_RNAME, SAM_QNAME, SAM_Q0NAME, SAM_Q1NAME, SAM_Q2NAME, SAM_Q3NAME, SAM_Q4NAME, SAM_Q5NAME, SAM_Q6NAME, SAM_Q7NAME, SAM_Q8NAME, SAM_Q9NAME, SAM_QmNAME, SAM_FLAG, SAM_FLAG0, SAM_FLAG1, SAM_POS, SAM_MAPQ, SAM_CIGAR, SAM_RNEXT, SAM_PNEXT, SAM_P0NEXT, SAM_P1NEXT, SAM_P2NEXT, SAM_P3NEXT, SAM_TLEN, SAM_AUX, SAM_SQBITMAP, SAM_NONREF, SAM_NONREF_X, SAM_GPOS, SAM_STRAND, SAM_SEQMIS_A, SAM_SEQMIS_C, SAM_SEQMIS_G, SAM_SEQMIS_T, SAM_QUAL, SAM_DOMQRUNS, SAM_QUALMPLX, SAM_DIVRQUAL, SAM_QNAMESA, SAM_QUALSA, SAM_EOL, SAM_BAM_BIN, SAM_TOPLEVEL, SAM_TOP2BAM, SAM_TOP2FQ, SAM_TOP2FQEX, SAM_TAXID, SAM_BUDDY, SAM_SAG, SAM_SAALN, SAM_MC_Z, SAM_DEBUG_LINES, OPTION_AM_i, OPTION_AS_i, OPTION_CC_Z, OPTION_CP_i, OPTION_CM_i, OPTION_FI_i, OPTION_H0_i, OPTION_H1_i, OPTION_H2_i, OPTION_MC_Z, OPTION_MD_Z, OPTION_MQ_i, OPTION_NH_i, OPTION_NH_PRIM, OPTION_IH_i, OPTION_HI_i, OPTION_NM_i, OPTION_PQ_i, OPTION_SM_i, OPTION_TC_i, OPTION_UQ_i, OPTION_U2_Z, OPTION_U2_DOMQRUNS, OPTION_U2_QUALMPLX, OPTION_U2_DIVRQUAL, OPTION_E2_Z, OPTION_2NONREF, OPTION_N2ONREFX, OPTION_2GPOS, OPTION_S2TRAND, OPTION_SA_Z, OPTION_SA_RNAME, OPTION_SA_STRAND, OPTION_SA_POS, OPTION_SA_CIGAR, OPTION_SA_NM, OPTION_SA_MAPQ, OPTION_SA_MAIN, OPTION_PG_Z, OPTION_PU_Z, OPTION_RG_Z, OPTION_LB_Z, OPTION_BC_Z, OPTION_CR_Z, OPTION_CB_Z, OPTION_CR_CB, OPTION_RX_Z, OPTION_OX_Z, OPTION_MI_Z, OPTION_CY_Z, OPTION_CY_ARR, OPTION_CY_DOMQRUNS, OPTION_CY_QUALMPLX, OPTION_CY_DIVRQUAL, OPTION_OQ_Z, OPTION_OQ_DOMQRUNS, OPTION_OQ_QUALMPLX, OPTION_OQ_DIVRQUAL, OPTION_OA_Z, OPTION_OA_RNAME, OPTION_OA_STRAND, OPTION_OA_POS, OPTION_OA_CIGAR, OPTION_OA_NM, OPTION_OA_MAPQ, OPTION_OC_Z, OPTION_OP_i, OPTION_X0_i, OPTION_X1_i, OPTION_XC_i, OPTION_XN_i, OPTION_XM_i, OPTION_XO_i, OPTION_XG_i, OPTION_XT_A, OPTION_XS_i, OPTION_XE_i, OPTION_XA_Z, OPTION_XA_LOOKBACK, OPTION_XA_RNAME, OPTION_XA_STRAND, OPTION_XA_POS, OPTION_XA_CIGAR, OPTION_XA_NM, OPTION_XA_STRAND_POS, OPTION_TS_A, OPTION_YF_Z, OPTION_YS_i, OPTION_XA_i, OPTION_ZS_i, OPTION_Zs_Z, OPTION_ZA_i, OPTION_ZB_i, OPTION_ZC_B_i, OPTION_ZF_i, OPTION_ZG_i, OPTION_ZM_B_s, OPTION_ZP_B_f, OPTION_ZT_Z, OPTION_YT_Z, OPTION_ZE_Z, OPTION_YE_Z, OPTION_ZK_Z, OPTION_YK_Z, OPTION_nM_i, OPTION_jM_B_c, OPTION_jI_B_I, OPTION_XS_A, OPTION_uT_A, OPTION_UR_Z, OPTION_UB_Z, OPTION_UY_Z, OPTION_UY_DOMQRUNS, OPTION_UY_QUALMPLX, OPTION_UY_DIVRQUAL, OPTION_TR_Z, OPTION_GN_Z, OPTION_GX_Z, OPTION_gn_Z, OPTION_gx_Z, OPTION_XL_i, OPTION_XQ_i, OPTION_XT_i, OPTION_cx_i, OPTION_qs_i, OPTION_qe_i, OPTION_ws_i, OPTION_we_i, OPTION_zm_i, OPTION_np_i, OPTION_ec_f, OPTION_rq_f, OPTION_sn_B_f, OPTION_dq_Z, OPTION_dt_Z, OPTION_iq_Z, OPTION_mq_Z, OPTION_sq_Z, OPTION_st_Z, OPTION_ip_B_C, OPTION_pw_B_C, OPTION_fi_B_C, OPTION_ri_B_C, OPTION_fp_B_C, OPTION_rp_B_C, OPTION_fn_i, OPTION_rn_i, OPTION_sz_A, OPTION_sc_A, OPTION_mc_i, OPTION_ms_i, OPTION_Z5_i, OPTION_Zq_i, OPTION_YH_Z, OPTION_YQ_Z, OPTION_XR_i, OPTION_QS_i, OPTION_QE_i, OPTION_XI_f, OPTION_CV_f, OPTION_XP_Z, OPTION_XO_Z, OPTION_XM_Z, OPTION_XG_Z, OPTION_XB_Z, OPTION_YS_Z, OPTION_XR_Z, OPTION_XB_A, OPTION_X4_Z, OPTION_X5_Z, OPTION_BD_Z, OPTION_BI_Z, OPTION_BD_BI, OPTION_tp_A, OPTION_cm_i, OPTION_s1_i, OPTION_s2_i, OPTION_nn_i, OPTION_ts_A, OPTION_cs_Z, OPTION_dv_f, OPTION_de_f, OPTION_rl_i, OPTION_tx_i, OPTION_CIGAR, SAM_E2_Z, SAM_U2_Z, NUM_SAM_FIELDS } SAMFields;
...
#define SAM_PREDEFINED { \
    ...
    [SAM_Q8NAME] = { { _SAM_Q8NAME }, TAG(Q7NAME) }, \
    [SAM_Q9NAME] = { { _SAM_Q9NAME }, TAG(Q7NAME) }, \
    ...
    [OPTION_NH_PRIM] = { { _OPTION_NH_PRIM }, TAG(NH_PRIM) }, \
    ...
    [OPTION_CR_CB] = { { _OPTION_CR_CB }, TAG(CR_CB:Z) }, \
    ...
    [OPTION_UY_DOMQRUNS] = { { _OPTION_UY_DOMQRUNS }, TAG(U0Y_DOMQ) }, \
    [OPTION_UY_QUALMPLX] = { { _OPTION_UY_QUALMPLX }, TAG(U1Y_MPLX) }, \
    [OPTION_UY_DIVRQUAL] = { { _OPTION_UY_DIVRQUAL }, TAG(U2Y_DEVQ) }, \
...
typedef enum { FASTQ_CONTIG, FASTQ_DESC, FASTQ_Q0NAME, FASTQ_Q1NAME, FASTQ_Q2NAME, FASTQ_Q3NAME, FASTQ_Q4NAME, FASTQ_Q5NAME, FASTQ_Q6NAME, FASTQ_Q7NAME, FASTQ_Q8NAME, FASTQ_Q9NAME, FASTQ_QmNAME, FASTQ_QNAME2, FASTQ_Q0NAME2, FASTQ_Q1NAME2, FASTQ_Q2NAME2, FASTQ_Q3NAME2, FASTQ_Q4NAME2, FASTQ_Q5NAME2, FASTQ_Q6NAME2, FASTQ_Q7NAME2, FASTQ_Q8NAME2, FASTQ_Q9NAME2, FASTQ_E1L, FASTQ_SQBITMAP, FASTQ_NONREF, FASTQ_NONREF_X, FASTQ_GPOS, FASTQ_STRAND, FASTQ_SEQMIS_A, FASTQ_SEQMIS_C, FASTQ_SEQMIS_G, FASTQ_SEQMIS_T, FASTQ_E2L, FASTQ_QUAL, FASTQ_DOMQRUNS, FASTQ_QUALMPLX, FASTQ_DIVRQUAL, FASTQ_TOPLEVEL, FASTQ_TAXID, FASTQ_DEBUG_LINES, FASTQ_LINE3, FASTQ_T0HIRD, FASTQ_T1HIRD, FASTQ_T2HIRD, FASTQ_T3HIRD, FASTQ_T4HIRD, FASTQ_T5HIRD, FASTQ_T6HIRD, FASTQ_T7HIRD, FASTQ_COPY_Q, NUM_FASTQ_FIELDS } FASTQFields;
...
#define MAX_NUM_FIELDS_PER_DATA_TYPE 241
