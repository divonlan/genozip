...
#define _SAM_SEQSA ((uint64_t)280570709267)
...
#define _SAM_SAGROUP ((uint64_t)22611797308031251)
...
#define _OPTION_MC_Z0 ((uint64_t)53164082671693)
#define _OPTION_MC_Z1 ((uint64_t)54263594299725)
...
#define _OPTION_sn_B ((uint64_t)1765437043)
...
typedef enum { SAM_RNAME, SAM_QNAME, SAM_Q0NAME, SAM_Q1NAME, SAM_Q2NAME, SAM_Q3NAME, SAM_Q4NAME, SAM_Q5NAME, SAM_Q6NAME, SAM_Q7NAME, SAM_Q8NAME, SAM_Q9NAME, SAM_QmNAME, SAM_FLAG, SAM_FLAG0, SAM_FLAG1, SAM_POS, SAM_MAPQ, SAM_CIGAR, SAM_RNEXT, SAM_PNEXT, SAM_TLEN, SAM_AUX, SAM_SQBITMAP, SAM_NONREF, SAM_NONREF_X, SAM_GPOS, SAM_STRAND, SAM_SEQMIS_A, SAM_SEQMIS_C, SAM_SEQMIS_G, SAM_SEQMIS_T, SAM_QUAL, SAM_DOMQRUNS, SAM_QUALMPLX, SAM_DIVRQUAL, SAM_QNAMESA, SAM_SEQSA, SAM_QUALSA, SAM_EOL, SAM_BAM_BIN, SAM_TOPLEVEL, SAM_TOP2BAM, SAM_TOP2FQ, SAM_TOP2FQEX, SAM_TAXID, SAM_BUDDY, SAM_SAGROUP, SAM_SAALN, SAM_MC_Z, SAM_DEBUG_LINES, OPTION_AM_i, OPTION_AS_i, OPTION_CC_Z, OPTION_CP_i, OPTION_CM_i, OPTION_E2_Z, OPTION_2NONREF, OPTION_N2ONREFX, OPTION_2GPOS, OPTION_S2TRAND, OPTION_FI_i, OPTION_H0_i, OPTION_H1_i, OPTION_H2_i, OPTION_LB_Z, OPTION_MC_Z, OPTION_MC_Z0, OPTION_MC_Z1, OPTION_MD_Z, OPTION_MQ_i, OPTION_NH_i, OPTION_HI_i, OPTION_NM_i, OPTION_OA_Z, OPTION_OA_RNAME, OPTION_OA_STRAND, OPTION_OA_POS, OPTION_OA_CIGAR, OPTION_OA_NM, OPTION_OA_MAPQ, OPTION_OC_Z, OPTION_PG_Z, OPTION_PQ_i, OPTION_PU_Z, OPTION_RG_Z, OPTION_SA_Z, OPTION_SA_RNAME, OPTION_SA_STRAND, OPTION_SA_POS, OPTION_SA_CIGAR, OPTION_SA_NM, OPTION_SA_MAPQ, OPTION_SA_MAIN, OPTION_SM_i, OPTION_TC_i, OPTION_UQ_i, OPTION_U2_Z, OPTION_U2_DOMQRUNS, OPTION_U2_QUALMPLX, OPTION_U2_DIVRQUAL, OPTION_X0_i, OPTION_X1_i, OPTION_XC_i, OPTION_XN_i, OPTION_XM_i, OPTION_XO_i, OPTION_XG_i, OPTION_XT_A, OPTION_XS_i, OPTION_XE_i, OPTION_XA_Z, OPTION_XA_LOOKBACK, OPTION_XA_RNAME, OPTION_XA_STRAND, OPTION_XA_POS, OPTION_XA_CIGAR, OPTION_XA_NM, OPTION_XA_STRAND_POS, OPTION_XS_A, OPTION_TS_A, OPTION_YF_Z, OPTION_YS_i, OPTION_XA_i, OPTION_ZA_i, OPTION_ZB_i, OPTION_ZC_B_i, OPTION_ZF_i, OPTION_ZG_i, OPTION_ZM_B_s, OPTION_ZP_B_f, OPTION_ZT_Z, OPTION_YT_Z, OPTION_ZE_Z, OPTION_YE_Z, OPTION_ZK_Z, OPTION_YK_Z, OPTION_nM_i, OPTION_jM_B_c, OPTION_jI_B_I, OPTION_cx_i, OPTION_qs_i, OPTION_qe_i, OPTION_ws_i, OPTION_we_i, OPTION_zm_i, OPTION_np_i, OPTION_ec_f, OPTION_rq_f, OPTION_sn_B, OPTION_dq_Z, OPTION_dt_Z, OPTION_iq_Z, OPTION_mq_Z, OPTION_sq_Z, OPTION_st_Z, OPTION_ip_B_C, OPTION_pw_B_C, OPTION_fi_B_C, OPTION_ri_B_C, OPTION_fp_B_C, OPTION_rp_B_C, OPTION_fn_i, OPTION_rn_i, OPTION_sz_A, OPTION_sc_A, OPTION_mc_i, OPTION_ms_i, OPTION_Z5_i, OPTION_Zq_i, OPTION_XO_Z, OPTION_XM_Z, OPTION_XG_Z, OPTION_BD_Z, OPTION_BI_Z, OPTION_BD_BI, OPTION_tp_A, OPTION_cm_i, OPTION_s1_i, OPTION_s2_i, OPTION_nn_i, OPTION_ts_A, OPTION_cs_Z, OPTION_dv_f, OPTION_de_f, OPTION_rl_i, OPTION_tx_i, OPTION_CIGAR, SAM_E2_Z, SAM_U2_Z, NUM_SAM_FIELDS } SAMFields;
...
#define SAM_PREDEFINED { \
    ...
    [SAM_SEQSA] = { { _SAM_SEQSA }, TAG(SEQSA) }, \
    ...
    [SAM_SAGROUP] = { { _SAM_SAGROUP }, TAG(SAGROUP) }, \
    ...
    [OPTION_MC_Z0] = { { _OPTION_MC_Z0 }, TAG(M0C:Z0) }, \
    [OPTION_MC_Z1] = { { _OPTION_MC_Z1 }, TAG(M1C:Z1) }, \
    ...
    [OPTION_sn_B] = { { _OPTION_sn_B }, TAG(sn:i) }, \
...
#define MAX_NUM_FIELDS_PER_DATA_TYPE 190
