...
#pragma GENDICT SAM_SAG=DTYPE_FIELD=SAG // PRIM and DEPN: the SA Group from which to copy data
#pragma GENDICT SAM_SAALN=DTYPE_FIELD=SAALN  // DEPN: SA:Z-groups: the alignment within SA Group which is this line (not needed for PRIM, as the aln_i is always 0)
...
#pragma GENDICT OPTION_NH_PRIM=DTYPE_2=NH_PRIM // SA Groups PRIM: NH:i used for loading groups - containing actual values (while OPTION_NH_i is used for reconstruction)
...
#pragma GENDICT OPTION_CR_CB=DTYPE_2=CR_CB:Z // shared item for CR and CB arrays
#pragma GENDICT OPTION_RX_Z=DTYPE_2=RX:Z     // Sequence bases of the (possibly corrected) unique molecular identifier
...
#pragma GENDICT OPTION_CY_ARR=DTYPE_2=CY_ARR // array items
#pragma GENDICT OPTION_CY_DOMQRUNS=DTYPE_FIELD=C0Y_DOMQ // these 3 must be right after OPTION_OQ_Z (similar to SAM_QUAL).
...
#pragma GENDICT OPTION_XM_i=DTYPE_2=XM:i     // Number of mismatches in the alignment (also bowtie2, bsbolt, hisat2)
#pragma GENDICT OPTION_XO_i=DTYPE_2=XO:i     // Number of gap opens (also bowtie2, bsbolt, hisat2)
#pragma GENDICT OPTION_XG_i=DTYPE_2=XG:i     // Number of gap extentions (also bowtie2, bsbolt, hisat2)
...
// XS:i, XN:i, XM:i, XO:i, XG:i - same as bwa
...
// YS:i, YF:Z - same as bowtie2
// XN:i, XM:i, XO:i, XG:i - same as bwa, bowtie2
// XS:A - same as STAR, same as standard TS:A, minimap2's ts:A
#pragma GENDICT OPTION_ZS_i=DTYPE_2=ZS:i     // Alignment score for the best-scoring alignment found other than the alignment reported. Can be negative.
...
#pragma GENDICT OPTION_UR_Z=DTYPE_2=UR:Z     // Chromium molecular barcode sequence as reported by the sequencer.
#pragma GENDICT OPTION_UB_Z=DTYPE_2=UB:Z     // Chromium molecular barcode sequence that is error-corrected among other molecular barcodes with the same cellular barcode and gene alignment.

#pragma GENDICT OPTION_UY_Z=DTYPE_2=UY:Z     // Chromium molecular barcode read quality. Phred scores as reported by sequencer.
#pragma GENDICT OPTION_UY_DOMQRUNS=DTYPE_FIELD=U0Y_DOMQ // these 3 must be right after OPTION_OQ_Z (similar to SAM_QUAL).
#pragma GENDICT OPTION_UY_QUALMPLX=DTYPE_FIELD=U1Y_MPLX 
#pragma GENDICT OPTION_UY_DIVRQUAL=DTYPE_FIELD=U2Y_DEVQ 

#pragma GENDICT OPTION_TR_Z=DTYPE_2=TR:Z     // Trimmed sequence. For the Single Cell 3' v1 chemistry, this is trailing sequence following the UMI on Read 2. For the Single Cell 3' v2 chemistry, this is trailing sequence following the cell and molecular barcodes on Read 1.
#pragma GENDICT OPTION_GN_Z=DTYPE_2=GN:Z     // Gene name for unique-gene reads
#pragma GENDICT OPTION_GX_Z=DTYPE_2=GX:Z     // Gene ID for for unique-gene reads
...
//#pragma GENDICT OPTION_XM_Z=DTYPE_2=XM:Z   // (overlap) methylation call string
#pragma GENDICT OPTION_XR_Z=DTYPE_2=XR:Z     // read conversion state for the alignment
//#pragma GENDICT OPTION_XR_Z=DTYPE_2=XR:Z   // (overlap) genome conversion state for the alignment
...
#pragma GENDICT OPTION_XB_A=DTYPE_2=XB:A     // Bisulfite conversion: C if its a C->T and G if its G->A: http://dcc.blueprint-epigenome.eu/#/md/bs_seq_grch38
...
COMPRESSOR_CALLBACK(sam_zip_UY);
...
#define SAM_SPECIAL { sam_cigar_special_CIGAR, sam_piz_special_TLEN_old, sam_piz_special_BD_BI, sam_piz_special_AS_old, \
                      ...
                      sam_piz_special_BISMARK_XG, sam_piz_special_HI, sam_piz_special_NH, sam_piz_special_SEQ_LEN,\
                      sam_piz_special_FI, sam_piz_special_cm \
                    }
...
SPECIAL (SAM, 41, NH,                    sam_piz_special_NH);                  // introduced 14.0.0
...
#define SAM_LOCAL_GET_LINE_CALLBACKS                          \
    ...
    { DT_SAM, _OPTION_UY_Z,        sam_zip_UY              }, 
...
#define BAM_LOCAL_GET_LINE_CALLBACKS                          \
    ...
    { DT_BAM, _OPTION_UY_Z,        sam_zip_UY              }, 
...
#define SAM_DICT_ID_ALIASES                    \
    /*         alias         maps to      */   \
    { DT_SAM,  _OPTION_UB_Z, _OPTION_UR_Z  },  \

#define BAM_DICT_ID_ALIASES                    \
    /*         alias         maps to      */   \
    { DT_BAM,  _OPTION_UB_Z, _OPTION_UR_Z  },  \
