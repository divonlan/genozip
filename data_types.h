...
typedef struct DataTypeProperties {
    ...
    bool (*inspect_txt_header) (VBlockP txt_header_vb, BufferP txt_header); // called by main thread to verify the txt header. returns false if this txt file should be skipped
