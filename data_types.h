...
/*    name         is_bin bin_type has_ra ht sizeof_vb      sizeof_zip_dataline   txt_headr 1st  is_header_done       unconsumed        inspect_txt_header,     zip_initialize        zip_finalize      zip_read_one_vb        zip_dts_flag          seg_initialize        seg_txt_line        seg_is_small,         seg_finalize,       compress                  piz_initialize         piz_finalize         piz_read_one_vb        is_skip_secetion           reconstruct_seq            container_filter       container_cb          num_special        special        num_trans        translators        release_vb           destroy_vb           cleanup_memory          show_sections_line stat_dict_types                 */ \
    ...
    { "CHAIN",     false, DT_NONE, NO_RA, 1, 0,             0,                    HDR_NONE, -1,  NULL,                chain_unconsumed, NULL,                   NULL,                 NULL,             NULL,                  NULL,                 chain_seg_initialize, chain_seg_txt_line, chain_seg_is_small,   chain_seg_finalize, NULL,                     NULL,                  NULL,                NULL,                  NULL,                      NULL,                      chain_piz_filter,      NULL,                 NUM_CHAIN_SPECIAL, CHAIN_SPECIAL, 0,               {},                NULL,                NULL,                NULL,                   "Alignment sets",  { "FIELD", "ERROR!", "ERROR!" } }, \
}  
