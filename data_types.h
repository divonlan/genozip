...
/*    name         is_bin \n-end bin_type    ht sizeof_vb      sizeof_zip_dataline   txt_headr hdr_contigs     1st  is_header_done       unconsumed        inspect_txt_header,     zip_initialize          zip_after_vbs,     zip_finalize         zip_read_one_vb        zip_after_compute          zip_dts_flag          seg_initialize          seg_txt_line          seg_is_small,         seg_finalize,         compress                  piz_header_init      piz_initialize          piz_finalize         piz_read_one_vb          is_skip_section             reconstruct_seq            container_filter       container_cb              con_item_cb          num_special        special        num_trans        translators        release_vb           destroy_vb           cleanup_memory          line_name        dtype_names                             */ \
    ...
    { "SAM",       false, true,  DT_BAM,     1, sam_vb_size,   sam_vb_zip_dl_size,   HDR_OK,   SAM_CONTIG_FMT, '@', NULL,                NULL,             sam_header_inspect,     sam_zip_initialize,     sam_zip_after_vbs, sam_header_finalize, NULL,                  sam_zip_after_compute,     sam_zip_dts_flag,     sam_seg_initialize,     sam_seg_txt_line,     sam_seg_is_small,     sam_seg_finalize,     NULL,                     NULL,                NULL,                   sam_header_finalize, sam_piz_read_one_vb,     sam_piz_is_skip_section,    sam_reconstruct_SEQ,       sam_piz_filter,        sam_piz_container_cb,     0,                   NUM_SAM_SPECIAL,   SAM_SPECIAL,   NUM_SAM_TRANS,   SAM_TRANSLATORS,   sam_vb_release_vb,   sam_vb_destroy_vb,   NULL,                   "Alignment",     { "FIELD", "QNAME",  "OPTION"         } }, \
    ...
    { "GFF3",      false, true,  DT_NONE,    1, 0,             0,                    HDR_OK,   NULL,           '#', NULL,                NULL,             NULL,                   gff3_zip_initialize,    NULL,              NULL,                NULL,                  NULL,                      NULL,                 gff3_seg_initialize,    gff3_seg_txt_line,    gff3_seg_is_small,    gff3_seg_finalize,    NULL,                     NULL,                NULL,                   NULL,                NULL,                    NULL,                       NULL,                      gff3_piz_filter,       NULL,                     0,                   0,                 {},            0,               {},                NULL,                NULL,                NULL,                   "Sequence",      { "FIELD", "ATTRS",  "ENST"           } }, \
    { "23ANDME",   false, true,  DT_NONE,    1, 0,             0,                    HDR_MUST, NULL,           '#', NULL,                NULL,             me23_header_inspect,    NULL,                   NULL,              NULL,                NULL,                  NULL,                      NULL,                 me23_seg_initialize,    me23_seg_txt_line,    me23_seg_is_small,    me23_seg_finalize,    NULL,                     NULL,                NULL,                   NULL,                NULL,                    NULL,                       NULL,                      NULL,                  NULL,                     0,                   0,                 {},            NUM_ME23_TRANS,  ME23_TRANSLATORS,  NULL,                NULL,                NULL,                   "SNP",           { "FIELD", "ERROR!", "ERROR!"         } }, \
    { "BAM",       true,  false, DT_NONE,    0, sam_vb_size,   sam_vb_zip_dl_size,   HDR_MUST, SAM_CONTIG_FMT, -1,  bam_is_header_done,  bam_unconsumed,   sam_header_inspect,     sam_zip_initialize,     sam_zip_after_vbs, sam_header_finalize, NULL,                  sam_zip_after_compute,     sam_zip_dts_flag,     bam_seg_initialize,     bam_seg_txt_line,     sam_seg_is_small,     sam_seg_finalize,     NULL,                     NULL,                NULL,                   sam_header_finalize, sam_piz_read_one_vb,     NULL,                       NULL,                      sam_piz_filter,        sam_piz_container_cb,     0,                   NUM_SAM_SPECIAL,   SAM_SPECIAL,   NUM_SAM_TRANS,   SAM_TRANSLATORS,   sam_vb_release_vb,   sam_vb_destroy_vb,   NULL,                   "Alignment",     { "FIELD", "QNAME",  "OPTION"         } }, \
    ...
    { "GENERIC",   true,  false, DT_GENERIC, 0, 0,             0,                    HDR_NONE, NULL,           -1,  NULL,                generic_unconsumed, NULL,                 NULL,                   NULL,              NULL,                NULL,                  NULL,                      NULL,                 NULL,                   NULL,                 generic_seg_is_small, generic_seg_finalize, NULL,                     NULL,                NULL,                   NULL,                NULL,                    NULL,                       NULL,                      NULL,                  NULL,                     0,                   NUM_GNRIC_SPECIAL, GNRIC_SPECIAL, 0,               {},                NULL,                NULL,                NULL,                   "N/A",           { "FIELD", "ERROR!", "ERROR!"         } }, \
