...
/*    name         is_bin \n-end bin_type    ht sizeof_vb      sizeof_zip_dataline   txt_headr   hdr_contigs     1st  is_header_done       unconsumed        inspect_txt_header,     zip_initialize          zip_after_vbs,     zip_finalize         zip_free_end_of_z      zip_init_vb        zip_after_compute          zip_dts_flag          zip_vb_has_count        zip_set_vb_header_specific      zip_set_txt_header_specific      seg_initialize          seg_txt_line          seg_is_small,         seg_finalize,         seg_get_vb_recon_size      seg_modifies compress                  zip_update_txt_counters      generate_recon_plan          stats_reallocate        zip_genozip_header        piz_genozip_header      piz_after_global_area   piz_preprocess                          piz_header_init      piz_initialize          piz_finalize         piz_maybe_reorder_lines        piz_init_vb          piz_recon_init              piz_init_line       piz_after_recon             piz_after_preproc      piz_xtra_line_data      is_skip_section             reconstruct_seq            container_filter       container_cb              con_item_cb          num_special        special        num_trans        translators        release_vb           destroy_vb           cleanup_memory          line_name        dtype_names                             */ \
    ...
    { "FASTQ",     false, true,  DT_NONE,    4, fastq_vb_size, fastq_vb_zip_dl_size, HDR_NONE,   NULL,           -1,  NULL,                fastq_unconsumed, NULL,                   fastq_zip_initialize,   NULL,              NULL,                NULL,                  fastq_zip_init_vb, NULL,                      fastq_zip_dts_flag,   NULL,                   NULL,                           NULL,                            fastq_seg_initialize,   fastq_seg_txt_line,   fastq_seg_is_small,   fastq_seg_finalize,   NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                   NULL,                   NULL,                                   NULL,                NULL,                   NULL,                fastq_piz_maybe_reorder_lines, fastq_piz_init_vb,   NULL,                       fastq_reset_line,   NULL,                       NULL,                  NULL,                   fastq_piz_is_skip_section,  fastq_recon_aligned_SEQ,   fastq_piz_filter,      fastq_piz_container_cb,   0,                   NUM_FASTQ_SPECIAL, FASTQ_SPECIAL, 0,               {},                fastq_vb_release_vb, fastq_vb_destroy_vb, NULL,                   "Sequence",      { "FIELD", "DESC",   "ERROR!"         } }, \
...
/* num_fields        pos              nonref        prim_chrom      luft_chrom      luft_pos         qname            eol             toplevel             predefined        */ \
  {NUM_REF_FIELDS,   DID_I_NONE,      DID_I_NONE,   CHROM,          DID_I_NONE,     DID_I_NONE,      DID_I_NONE,      {},             {},                  REF_PREDEFINED    }, \
  ...
  {NUM_VCF_FIELDS,   VCF_POS,         DID_I_NONE,   CHROM,          VCF_oCHROM,     VCF_oPOS,        DID_I_NONE,      {_VCF_EOL},     {_VCF_TOPLEVEL},     VCF_PREDEFINED    }, \
  {NUM_GNRIC_FIELDS, DID_I_NONE,      DID_I_NONE,   DID_I_NONE,     DID_I_NONE,     DID_I_NONE,      DID_I_NONE,      {},             {_GNRIC_TOPLEVEL},   GNRIC_PREDEFINED  }, \
  ...
  {NUM_LOCS_FIELDS,  DID_I_NONE,      DID_I_NONE,   DID_I_NONE,     DID_I_NONE,     DID_I_NONE,      DID_I_NONE,      {},             {_LOCS_TOPLEVEL},    LOCS_PREDEFINED   }, \
}
