...
/*    name         is_bin bin_type has_ra ht sizeof_vb      sizeof_zip_dataline   txt_headr header_contigs  1st  is_header_done       unconsumed        inspect_txt_header,     zip_initialize        zip_finalize        zip_read_one_vb        zip_after_compute      zip_dts_flag          seg_initialize        seg_txt_line        seg_is_small,         seg_finalize,       compress                  piz_header_init      piz_initialize         piz_finalize         piz_read_one_vb        is_skip_secetion           reconstruct_seq            container_filter       container_cb          num_special        special        num_trans        translators        release_vb           destroy_vb           cleanup_memory          show_sections_line stat_dict_types                 */ \
    ...
    { "BAM",       true,  DT_NONE, RA,    0, sam_vb_size,   sam_vb_zip_dl_size,   HDR_MUST, SAM_CONTIG_FMT, -1,  bam_is_header_done,  bam_unconsumed,   sam_header_inspect,     NULL,                 txtheader_finalize, NULL,                  NULL,                  sam_zip_dts_flag,     bam_seg_initialize,   bam_seg_txt_line,   sam_seg_is_small,     sam_seg_finalize,   NULL,                     NULL,                NULL,                  txtheader_finalize,  NULL,                  NULL,                      NULL,                      NULL          ,        sam_piz_container_cb, NUM_SAM_SPECIAL,   SAM_SPECIAL,   NUM_SAM_TRANS,   SAM_TRANSLATORS,   sam_vb_release_vb,   sam_vb_destroy_vb,   NULL,                   "Alignment lines", { "FIELD", "QNAME",  "OPTION" } }, \
    ...
    { "PHYLIP",    false, DT_NONE, NO_RA, 1, 0,             phy_vb_zip_dl_size,   HDR_MUST, NULL,           -1,  phy_is_header_done,  NULL,             phy_header_inspect,     NULL,                 NULL,               NULL,                  NULL,                  NULL,                 phy_seg_initialize,   phy_seg_txt_line,   phy_seg_is_small,     phy_seg_finalize,   NULL,                     NULL,                NULL,                  NULL,                NULL,                  NULL,                      NULL,                      NULL,                  NULL,                 0,                 {},            0,               {},                NULL,                NULL,                NULL,                   "Sequences",       { "FIELD", "ERROR!", "ERROR!" } }, \
    { "CHAIN",     false, DT_NONE, NO_RA, 1, 0,             0,                    HDR_NONE, NULL,           -1,  NULL,                chain_unconsumed, NULL,                   NULL,                 NULL,               NULL,                  NULL,                  NULL,                 chain_seg_initialize, chain_seg_txt_line, chain_seg_is_small,   chain_seg_finalize, NULL,                     NULL,                chain_piz_initialize,  NULL,                NULL,                  NULL,                      NULL,                      chain_piz_filter,      NULL,                 NUM_CHAIN_SPECIAL, CHAIN_SPECIAL, 0,               {},                NULL,                NULL,                NULL,                   "Alignment sets",  { "FIELD", "ERROR!", "ERROR!" } }, \
}  
...
typedef enum { CHAIN_NAMESRC, CHAIN_STRNDSRC, CHAIN_STARTSRC, CHAIN_ENDSRC, CHAIN_SIZESRC,
               CHAIN_NAMEDST, CHAIN_STRNDDST, CHAIN_STARTDST, CHAIN_ENDDST, CHAIN_SIZEDST,
...
/* num_fields        pos         test_regions    info        nonref        ochrom,     eol        toplevel names (including extend fields) - max 8 characters - 2 first chars must be unique within each data type (for dict_id_to_did_i_map) */ \
  ...
  {NUM_CHAIN_FIELDS, -1,         CHAIN_NAMEDST,  -1,         -1,           -1,         CHAIN_EOL, CHAIN_TOPLEVEL, { "NAMESRC", "SRANDSRC", "STARTSRC", "ENDSRC", "SIZESRC", "NaMEDST", "SrANDDST", "StARTDST", "EnDDST", "SiZEDST", "CHAIN", "SCORE", "ID", "SET", "SIZE", "GAPS", "EOL", TOPLEVEL } }, /* unique first 2 letters */ \
}
