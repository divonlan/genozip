...
/*    name       has_ra sizeof_vb     sizeof_zip_dataline  txt_headr 1st  zip_initialize        seg_initialize        seg_txt_line        compress                  update_header                    read_one_vb           uncompress                is_skip_secetion           num_special        special        release_vb          destroy_vb           cleanup_memory          show_sections_line stat_dict_types                 */ \
    { "REFERENCE", RA,  fast_vb_size, fast_vb_zip_dl_size, HDR_NONE, -1,  ref_make_ref_init,  fasta_seg_initialize, fasta_seg_txt_line, fasta_make_ref_range,     NULL,                            NULL,                 NULL,                     NULL,                      0,                 {},            fast_vb_release_vb, NULL,                NULL,                   "Lines",           { "FIELD", "DESC",   "ERROR!" } }, \
    ...
    { "FASTA",   RA,    fast_vb_size, fast_vb_zip_dl_size, HDR_NONE, -1,  NULL,               fasta_seg_initialize, fasta_seg_txt_line, NULL,                     NULL,                            fast_piz_read_one_vb, fasta_piz_reconstruct_vb, fasta_piz_is_skip_section, NUM_FASTA_SPECIAL, FASTA_SPECIAL, fast_vb_release_vb, NULL,                NULL,                   "Lines",           { "FIELD", "DESC",   "ERROR!" } }, \
