...
/*    name       has_ra sizeof_vb     sizeof_zip_dataline  txt_headr 1st  zip_initialize        seg_initialize        seg_txt_line        compress                  update_header                          read_one_vb           uncompress                is_skip_secetion           num_special        special        release_vb          destroy_vb           cleanup_memory          show_sections_line stat_dict_types                 */ \
    ...
    { "SAM",     RA,    sam_vb_size,  sam_vb_zip_dl_size,  HDR_OK,   '@', sam_zip_initialize,   sam_seg_initialize,   sam_seg_txt_line,   NULL,                     zfile_update_compressed_vb_header,     NULL,                 sam_piz_reconstruct_vb,   NULL,                      NUM_SAM_SPECIAL,   SAM_SPECIAL,   sam_vb_release_vb,  sam_vb_destroy_vb,   NULL,                   "Alignment lines", { "FIELD", "QNAME",  "OPTION" } }, \
    { "FASTQ",   NO_RA, fast_vb_size, fast_vb_zip_dl_size, HDR_NONE, -1,  NULL,                 fastq_seg_initialize, fastq_seg_txt_line, NULL,                     zfile_update_compressed_vb_header,     fast_piz_read_one_vb, fastq_piz_reconstruct_vb, fastq_piz_is_skip_section, 0,                 {},            fast_vb_release_vb, NULL,                NULL,                   "Entries",         { "FIELD", "DESC",   "ERROR!" } }, \
    { "FASTA",   RA,    fast_vb_size, fast_vb_zip_dl_size, HDR_NONE, -1,  ref_make_ref_init,    fasta_seg_initialize, fasta_seg_txt_line, fasta_make_ref_range     ,zfile_update_compressed_vb_header,     fast_piz_read_one_vb, fasta_piz_reconstruct_vb, fasta_piz_is_skip_section, NUM_FASTA_SPECIAL, FASTA_SPECIAL, fast_vb_release_vb, NULL,                NULL,                   "Lines",           { "FIELD", "DESC",   "ERROR!" } }, \
    { "GVF",     RA,    0,            0,                   HDR_OK,   '#', NULL,                 gff3_seg_initialize,  gff3_seg_txt_line,  NULL,                     zfile_update_compressed_vb_header,     NULL,                 gff3_piz_reconstruct_vb,  NULL,                      0,                 {},            NULL,               NULL,                NULL,                   "Sequences",       { "FIELD", "ATTRS",  "ITEMS"  } }, \
    { "23ANDME", RA,    0,            0,                   HDR_OK,   '#', NULL,                 me23_seg_initialize,  me23_seg_txt_line,  NULL,                     zfile_update_compressed_vb_header,     NULL,                 me23_piz_reconstruct_vb,  NULL,                      0,                 {},            NULL,               NULL,                NULL,                   "SNPs",            { "FIELD", "ERROR!", "ERROR!" } }  \
}
...
/* num_fields        chrom         pos         info        eol        names (including extend fields) - max 8 characters                                                                  */ \
  {NUM_VCF_FIELDS,   VCF_CHROM,    VCF_POS,    VCF_INFO,   VCF_EOL,   { "CHROM", "POS", "ID", "REF+ALT", "QUAL", "FILTER", "INFO", "FORMAT", "GT", "EOL" },                    }, \
  {NUM_SAM_FIELDS,   SAM_RNAME,    SAM_POS,    -1,         SAM_EOL,   { "RNAME", "QNAME", "FLAG", "POS", "MAPQ", "CIGAR", "RNEXT", "PNEXT", "TLEN", "OPTIONAL", "SEQ" /* for stats display */, "SEQNOREF", "QUAL", "EOL" }, }, \
