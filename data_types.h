...
typedef struct DataTypeProperties {
    ...
    void (*read_vblock) (VBlockP);     // called by I/O thread zip_one_file - override default txtfile_read_vblock
