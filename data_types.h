...
/*    name         is_bin bin_type has_ra ht sizeof_vb     sizeof_zip_dataline  txt_headr 1st  is_header_done       unconsumed        inspect_txt_header,     zip_initialize        zip_finalize      zip_read_one_vb        zip_dts_flag          seg_initialize        seg_txt_line        seg_finalize,       compress                  piz_initialize         piz_finalize         piz_read_one_vb        is_skip_secetion           reconstruct_seq            container_filter       container_cb          num_special        special        num_trans        translators        release_vb          destroy_vb           cleanup_memory          show_sections_line stat_dict_types                 */ \
    { "REFERENCE", false, DT_NONE, RA,    1, fast_vb_size, fast_vb_zip_dl_size, HDR_NONE, -1,  NULL,                fasta_unconsumed, NULL,                   ref_make_ref_init,    NULL,             NULL,                  NULL,                 fasta_seg_initialize, fasta_seg_txt_line, NULL,               ref_make_create_range,    NULL,                  NULL,                NULL,                  NULL,                      NULL,                      NULL,                  NULL,                 0,                 {},            0,               {},                fast_vb_release_vb, NULL,                NULL,                   "Lines",           { "FIELD", "DESC",   "ERROR!" } }, \
    ...
    { "FASTQ",     false, DT_NONE, NO_RA, 4, fast_vb_size, fast_vb_zip_dl_size, HDR_NONE, -1,  NULL,                fastq_unconsumed, NULL,                   fastq_zip_initialize, NULL,             fastq_zip_read_one_vb, fastq_zip_dts_flag,   fastq_seg_initialize, fastq_seg_txt_line, fastq_seg_finalize, NULL,                     fastq_piz_initialize,  NULL,                fastq_piz_read_one_vb, fastq_piz_is_skip_section, fastq_reconstruct_seq,     fastq_piz_filter,      NULL,                 0,                 {},            0,               {},                fast_vb_release_vb, fast_vb_destroy_vb,  NULL,                   "Entries",         { "FIELD", "DESC",   "ERROR!" } }, \
    { "FASTA",     false, DT_NONE, RA,    1, fast_vb_size, fast_vb_zip_dl_size, HDR_NONE, -1,  NULL,                fasta_unconsumed, NULL,                   NULL,                 NULL,             NULL,                  NULL,                 fasta_seg_initialize, fasta_seg_txt_line, fasta_seg_finalize, NULL,                     fasta_piz_initialize,  NULL,                fasta_piz_read_one_vb, fasta_piz_is_skip_section, NULL,                      fasta_piz_filter,      NULL,                 NUM_FASTA_SPECIAL, FASTA_SPECIAL, 0,               {},                fast_vb_release_vb, fast_vb_destroy_vb,  NULL,                   "Lines",           { "FIELD", "DESC",   "ERROR!" } }, \
