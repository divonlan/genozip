...
extern void kraken_piz_initialize (void);
...
extern bool kraken_is_included_stored (VBlockP vb, DidIType did_i_taxid);

// using the kraken data in genozip --kraken
extern bool kraken_seg_taxid (VBlockP vb, DidIType did_i_taxid, const char *qname, unsigned qname_len, bool fail_if_missing);
