...
extern void random_access_pos_of_chrom (WordIndex chrom_word_index, int64_t *min_pos, int64_t *max_pos);
extern void random_access_get_ra_info (uint32_t vblock_i, WordIndex *chrom_index, int64_t *min_pos, int64_t *max_pos);
