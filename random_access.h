...
extern void random_access_update_last_pos (VBlockP vb, uint32_t last_pos);
extern void random_access_merge_in_vb (VBlockP vb);
extern void random_access_merge_in_evb (void);
...
extern uint32_t random_access_get_vb0_max_pos (uint32_t chrom_word_index);
