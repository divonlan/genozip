...
extern void random_access_update_pos (VBlockP vb, int ra_i, DidIType did_i_pos);
...
extern void random_access_compress (ConstBufferP ra_buf, SectionType sec_type, int ra_i, rom msg);
...
extern void random_access_load_ra_section (SectionType section_type, DidIType chrom_did_i, BufferP ra_buf, rom buf_name, rom show_index_msg);
