...
/*                 name         is_bin \n-end use_ref txt_type   bin_type  sizeof_vb       sizeof_zip_dataline   txt_headr   hdr_contigs     1st  is_header_done          unconsumed          inspect_txt_header      is_data_type  zip_initialize          zip_after_segconf        zip_after_vbs,     zip_finalize         zip_end_of_z           zip_init_vb        zip_after_compute          zip_set_vb_header_specific        zip_set_txt_header_flags         zip_modify        seg_initialize          seg_txt_line          assseg_line          seg_is_big            seg_is_small          seg_finalize          segconf_finalize        zip_custom_merge     seg_modifies zip_comp_cb        zip_after_compress        stats_reallocate        zip_genozip_header        piz_genozip_header        piz_after_global_area   piz_preprocess                          piz_header_init        piz_initialize          piz_finalize         piz_after_vb_header        piz_init_vb          piz_vb_recon_init           piz_init_line       piz_after_recon             piz_process_recon         piz_after_preproc_vb      piz_preproc_finalize      piz_xtra_line_data      is_skip_section             reconstruct_seq            container_filter       container_cb              con_item_cb          num_special          special          num_trans        translators         line_name        dtype_names                             */ \
    ...
    [DT_FASTQ] = { "FASTQ",     false, true,  true,   DT_FASTQ,  DT_NONE,  fastq_vb_size,  fastq_vb_zip_dl_size, HDR_NONE,   NULL,           -1,  NULL,                   fastq_unconsumed,   NULL,                   is_fastq,     fastq_zip_initialize,   fastq_zip_after_segconf, NULL,              fastq_zip_finalize,  NULL,                  fastq_zip_init_vb, fastq_zip_after_compute,   fastq_zip_set_vb_header_specific, fastq_zip_set_txt_header_flags,  fastq_zip_modify, fastq_seg_initialize,   fastq_seg_txt_line,   fastq_assseg_line,   NULL,                 fastq_seg_is_small,   fastq_seg_finalize,   fastq_segconf_finalize, NULL,                false,       fastq_zip_comp_cb, fastq_zip_after_compress, NULL,                   fastq_zip_genozip_header, fastq_piz_genozip_header, NULL,                   NULL,                                   fastq_piz_header_init, fastq_piz_initialize,   NULL,                fastq_piz_after_vb_header, fastq_piz_init_vb,   NULL,                       fastq_reset_line,   NULL,                       fastq_piz_process_recon,  NULL,                     NULL,                     NULL,                   fastq_piz_is_skip_section,  fastq_recon_aligned_SEQ,   fastq_piz_filter,      fastq_piz_container_cb,   0,                   NUM_FASTQ_SPECIAL,   FASTQ_SPECIAL,   0,               {},                 "read",          { "FIELD", "QNAME",  "AUX"            } }, \
