...
typedef struct DataTypeProperties {
    ...
    bool (*is_data_type) (STRp(header), bool *need_more); // ZIP: check for signature of the data type, to rescue generic files
...
/*    name         is_bin \n-end txt_type     bin_type    ht sizeof_vb       sizeof_zip_dataline   txt_headr   hdr_contigs     1st  is_header_done          unconsumed          inspect_txt_header      is_data_type  zip_initialize          zip_after_segconf  zip_after_vbs,     zip_finalize         zip_free_end_of_z      zip_init_vb        zip_after_compute          zip_dts_flag          zip_vb_has_count        zip_set_vb_header_specific        zip_set_txt_header_specific      seg_initialize          seg_txt_line          seg_is_big            seg_is_small          seg_finalize          zip_custom_merge seg_get_vb_recon_size      seg_modifies zip_after_compress        zip_update_txt_counters      generate_recon_plan          stats_reallocate        zip_genozip_header        piz_genozip_header        piz_after_global_area   piz_preprocess                          piz_header_init      piz_initialize          piz_finalize         piz_maybe_reorder_lines        piz_init_vb          piz_recon_init              piz_init_line       piz_after_recon             piz_process_recon        piz_after_preproc      piz_xtra_line_data      is_skip_section             reconstruct_seq            container_filter       container_cb              con_item_cb          num_special         special         num_trans        translators         release_vb            destroy_vb           cleanup_memory          line_name        dtype_names                             */ \
    ...
    { "KRAKEN",    false, true,  DT_KRAKEN,   DT_NONE,    1, kraken_vb_size, 0,                    HDR_NONE,   NULL,           -1,  NULL,                   NULL,               NULL,                   NULL,         kraken_zip_initialize,  NULL,              NULL,              NULL,                NULL,                  NULL,              kraken_zip_after_compute,  NULL,                 NULL,                   NULL,                             NULL,                            kraken_seg_initialize,  kraken_seg_txt_line,  NULL,                 kraken_seg_is_small,  kraken_seg_finalize,  NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                kraken_piz_initialize,  NULL,                NULL,                          NULL,                NULL,                       NULL,               NULL,                       NULL,                    NULL,                  NULL,                   kraken_piz_is_skip_section, NULL,                      NULL,                  kraken_piz_container_cb,  0,                   NUM_KRAKEN_SPECIAL, KRAKEN_SPECIAL, 0,               {},                 kraken_vb_release_vb, NULL,                NULL,                   "Sequence",      { "FIELD", "QNAME",  "SEQLEN"         } }, \
...
extern void dt_piz_update_for_backcomp (void);
