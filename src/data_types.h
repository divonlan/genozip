...
/*                 name         is_bin \n-end use_ref txt_type   bin_type  sizeof_vb       sizeof_zip_dataline   txt_headr   hdr_contigs     1st  is_header_done          unconsumed          inspect_txt_header      is_data_type  zip_initialize          zip_after_segconf  zip_after_vbs,     zip_finalize         zip_free_end_of_z      zip_init_vb        zip_after_compute          zip_dts_flag          zip_set_vb_header_specific        zip_set_txt_header_flags         seg_initialize          seg_txt_line          assseg_line          seg_is_big            seg_is_small          seg_finalize          zip_custom_merge seg_modifies zip_after_compress        generate_recon_plan          stats_reallocate        zip_genozip_header        piz_genozip_header        piz_after_global_area   piz_preprocess                          piz_header_init        piz_initialize          piz_finalize         piz_before_read        piz_init_vb          piz_recon_init              piz_init_line       piz_after_recon             piz_process_recon         piz_after_preproc      piz_xtra_line_data      is_skip_section             reconstruct_seq            container_filter       container_cb              con_item_cb          num_special          special          num_trans        translators         line_name        dtype_names                             */ \
    [DT_VCF]   = { "VCF",       false, true,  true,   DT_VCF,    DT_NONE,  vcf_vb_size,    vcf_vb_zip_dl_size,   HDR_MUST,   VCF_CONTIG_FMT, '#', vcf_is_header_done,     NULL,               vcf_inspect_txt_header, is_vcf,       vcf_zip_initialize,     NULL,              vcf_zip_after_vbs, vcf_zip_finalize,    vcf_header_finalize,   vcf_zip_init_vb,   vcf_zip_after_compute,     NULL,                 vcf_zip_set_vb_header_specific,   vcf_zip_set_txt_header_flags,    vcf_seg_initialize,     vcf_seg_txt_line,     NULL,                vcf_seg_is_big,       vcf_seg_is_small,     vcf_seg_finalize,     NULL,            false,       vcf_zip_after_compress,   NULL,                        NULL,                   vcf_zip_genozip_header,   vcf_piz_genozip_header,   NULL,                   NULL,                                   vcf_piz_header_init,   NULL,                   vcf_piz_finalize,    NULL,                  vcf_piz_init_vb,     vcf_piz_recon_init,         vcf_reset_line,     NULL,                       NULL,                     NULL,                  NULL,                   vcf_piz_is_skip_section,    NULL,                      vcf_piz_filter,        vcf_piz_container_cb,     vcf_piz_con_item_cb, NUM_VCF_SPECIAL,     VCF_SPECIAL,     0,               {},                 "variant",       { "FIELD", "INFO",   "FORMAT", "BOTH" } }, \
    [DT_BCF]   = { "BCF",       true,  true,  true,   DT_VCF,    DT_BCF,   vcf_vb_size,    vcf_vb_zip_dl_size,   HDR_MUST,   VCF_CONTIG_FMT, '#', NULL,                   NULL,               vcf_inspect_txt_header, NULL,         vcf_zip_initialize,     NULL,              vcf_zip_after_vbs, vcf_zip_finalize,    vcf_header_finalize,   vcf_zip_init_vb,   vcf_zip_after_compute,     NULL,                 vcf_zip_set_vb_header_specific,   vcf_zip_set_txt_header_flags,    vcf_seg_initialize,     vcf_seg_txt_line,     NULL,                vcf_seg_is_big,       vcf_seg_is_small,     vcf_seg_finalize,     NULL,            false,       vcf_zip_after_compress,   NULL,                        NULL,                   vcf_zip_genozip_header,   vcf_piz_genozip_header,   NULL,                   NULL,                                   vcf_piz_header_init,   NULL,                   vcf_piz_finalize,    NULL,                  vcf_piz_init_vb,     vcf_piz_recon_init,         vcf_reset_line,     NULL,                       NULL,                     NULL,                  NULL,                   vcf_piz_is_skip_section,    NULL,                      vcf_piz_filter,        vcf_piz_container_cb,     vcf_piz_con_item_cb, NUM_VCF_SPECIAL,     VCF_SPECIAL,     0,               {},                 "variant",       { "FIELD", "INFO",   "FORMAT", "BOTH" } }, \
    ...
    [DT_ME23]  = { "23ANDME",   false, true,  false,  DT_ME23,   DT_NONE,  0,              0,                    HDR_MUST,   NULL,           '#', NULL,                   NULL,               me23_header_inspect,    is_me23,      NULL,                   NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                             NULL,                            me23_seg_initialize,    me23_seg_txt_line,    NULL,                NULL,                 me23_seg_is_small,    me23_seg_finalize,    NULL,            false,       NULL,                     NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                  NULL,                   NULL,                NULL,                  NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   0,                   {},              NUM_ME23_TRANS,  ME23_TRANSLATORS,   "SNP",           { "FIELD", "ERROR!", "ERROR!"         } }, \
...
#define DATA_TYPE_FUNCTIONS_DEFAULT /* only applicable to (some) functions */ \
                 { "DEFAULT",   false, false, false,  DT_NONE,   DT_NONE,  def_vb_size,    0,                    0,          0,              0,   def_is_header_done,     def_unconsumed,     0,                      NULL,         0,                      NULL,              0,                 0,                   0,                     0,                 0,                         0,                    NULL,                             NULL,                            0,                      0,                    textual_assseg_line, NULL,                 0,                    0,                    NULL,            false,       NULL,                     0,                           NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   0,                     0,                      NULL,                0,                     0,                   0,                          NULL,               0,                          NULL,                     NULL,                  NULL,                   0,                          0,                         default_piz_filter,    0,                        0,                   0,                  {},             0,               {},                 "",              { "FIELD", "DTYPE1", "DTYPE2"         } }
...
extern DataType dt_get_dt_for_genozip_header (DataType dt, Codec source_codec);
