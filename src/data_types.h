...
/*    name         is_bin \n-end txt_type     bin_type    ht sizeof_vb       sizeof_zip_dataline   txt_headr   hdr_contigs     1st  is_header_done          unconsumed          inspect_txt_header      is_data_type  zip_initialize          zip_after_segconf  zip_after_vbs,     zip_finalize         zip_free_end_of_z      zip_init_vb        zip_after_compute          zip_dts_flag          zip_vb_has_count        zip_set_vb_header_specific        zip_set_txt_header_flags         seg_initialize          seg_txt_line          seg_is_big            seg_is_small          seg_finalize          zip_custom_merge seg_get_vb_recon_size      seg_modifies zip_after_compress        zip_update_txt_counters      generate_recon_plan          stats_reallocate        zip_genozip_header        piz_genozip_header        piz_after_global_area   piz_preprocess                          piz_header_init      piz_initialize          piz_finalize         piz_before_read        piz_init_vb          piz_recon_init              piz_init_line       piz_after_recon             piz_process_recon         piz_after_preproc      piz_xtra_line_data      is_skip_section             reconstruct_seq            container_filter       container_cb              con_item_cb          num_special         special         num_trans        translators         release_vb            destroy_vb      erase_vb_bufs      line_name        dtype_names                             */ \
    ...
    { "GENERIC",   true,  false, DT_GENERIC,  DT_GENERIC, 0, 0,              0,                    HDR_OK,     NULL,           -1,  generic_is_header_done, generic_unconsumed, NULL,                   NULL,         NULL,                   NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                   NULL,                             NULL,                            generic_seg_initialize, NULL,                 NULL,                 generic_seg_is_small, generic_seg_finalize, NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                NULL,                   NULL,                NULL,                  NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   NUM_GNRIC_SPECIAL,  GNRIC_SPECIAL,  0,               {},                 NULL,                 NULL,           NULL,              "N/A",           { "FIELD", "ERROR!", "ERROR!"         } }, \
    { "PHYLIP",    false, true,  DT_PHYLIP,   DT_NONE,    1, 0,              phy_vb_zip_dl_size,   HDR_MUST,   NULL,           -1,  phy_is_header_done,     NULL,               phy_header_inspect,     NULL,         NULL,                   NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                   NULL,                             NULL,                            phy_seg_initialize,     phy_seg_txt_line,     NULL,                 phy_seg_is_small,     phy_seg_finalize,     NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                NULL,                   NULL,                NULL,                  NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   0,                  {},             NUM_PHYLIP_TRANS,PHYLIP_TRANSLATORS, NULL,                 NULL,           NULL,              "Sequence",      { "FIELD", "ERROR!", "ERROR!"         } }, \
    ...
    { "KRAKEN",    false, true,  DT_KRAKEN,   DT_NONE,    1, kraken_vb_size, 0,                    HDR_NONE,   NULL,           -1,  NULL,                   NULL,               NULL,                   NULL,         kraken_zip_initialize,  NULL,              NULL,              NULL,                NULL,                  NULL,              kraken_zip_after_compute,  NULL,                 NULL,                   NULL,                             NULL,                            kraken_seg_initialize,  kraken_seg_txt_line,  NULL,                 kraken_seg_is_small,  kraken_seg_finalize,  NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                kraken_piz_initialize,  NULL,                NULL,                  NULL,                NULL,                       NULL,               NULL,                       kraken_piz_process_recon, NULL,                  NULL,                   kraken_piz_is_skip_section, NULL,                      NULL,                  kraken_piz_container_cb,  0,                   NUM_KRAKEN_SPECIAL, KRAKEN_SPECIAL, 0,               {},                 kraken_vb_release_vb, NULL,           NULL,              "Sequence",      { "FIELD", "QNAME",  "SEQLEN"         } }, \
    ...
    { "BED",       false, true,  DT_BED,      DT_NONE,    1, 0,              0,                    HDR_OK,     NULL,           -1,  bed_is_header_done,     NULL,               NULL,                   is_bed,       bed_zip_initialize,     NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                   NULL,                             NULL,                            bed_seg_initialize,     bed_seg_txt_line,     NULL,                 bed_seg_is_small,     bed_seg_finalize,     NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                NULL,                   NULL,                NULL,                  NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   NUM_BED_SPECIAL,    BED_SPECIAL,    0,               {},                 NULL,                 NULL,           NULL,              "Line",          { "FIELD", "ERROR!", "ERROR!"         } }, \
}  
#define DATA_TYPE_FUNCTIONS_DEFAULT /* only applicable to (some) functions */ \
    { "DEFAULT",   false, false, DT_NONE,     DT_NONE,    0, def_vb_size,    0,                    0,          0,              0,   def_is_header_done,     def_unconsumed,     0,                      NULL,         0,                      NULL,              0,                 0,                   0,                     0,                 0,                         0,                    NULL,                   NULL,                             NULL,                            0,                      0,                    NULL,                 0,                    0,                    NULL,            0,                         false,       NULL,                     NULL,                        0,                           NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   0,                   0,                      NULL,                0,                     0,                   0,                          NULL,               0,                          NULL,                     NULL,                  NULL,                   0,                          0,                         container_no_filter,   0,                        0,                   0,                  {},             0,               {},                 0,                    0,              0,                 "",              {                                     } }
