...
/*                 name         is_bin \n-end use_ref txt_type   bin_type  sizeof_vb       sizeof_zip_dataline   txt_headr   hdr_contigs     1st  is_header_done          unconsumed          inspect_txt_header      is_data_type  zip_initialize          zip_after_segconf        zip_after_vbs,     zip_finalize         zip_end_of_z           zip_init_vb        zip_after_compute          zip_dts_flag          zip_set_vb_header_specific        zip_set_txt_header_flags         zip_modify        seg_initialize          seg_txt_line          assseg_line          seg_is_big            seg_is_small          seg_finalize          segconf_finalize        zip_custom_merge     seg_modifies zip_comp_cb        zip_after_compress        stats_reallocate        zip_genozip_header        piz_genozip_header        piz_after_global_area   piz_preprocess                          piz_header_init        piz_initialize          piz_finalize         piz_after_vb_header        piz_init_vb          piz_vb_recon_init           piz_init_line       piz_after_recon             piz_process_recon         piz_after_preproc_vb      piz_preproc_finalize      piz_xtra_line_data      is_skip_section             reconstruct_seq            container_filter       container_cb              con_item_cb          num_special          special          num_trans        translators         line_name        dtype_names                             */ \
    ...
    [DT_ME23]  = { "23ANDME",   false, true,  false,  DT_ME23,   DT_NONE,  0,              0,                    HDR_MUST,   NULL,           '#', NULL,                   NULL,               me23_header_inspect,    is_me23,      NULL,                   NULL,                    NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                             NULL,                            NULL,             me23_seg_initialize,    me23_seg_txt_line,    NULL,                NULL,                 me23_seg_is_small,    me23_seg_finalize,    NULL,                   NULL,                false,       NULL,              NULL,                     NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                  NULL,                   NULL,                NULL,                      NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                     NULL,                     NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   0,                   {},              NUM_ME23_TRANS,  ME23_TRANSLATORS,   "SNP",           { "FIELD", "ERROR!", "ERROR!"         } }, \
    [DT_GNRIC] = { "GENERIC",   true,  false, false,  DT_NONE,   DT_GNRIC, 0,              0,                    HDR_OK,     NULL,           -1,  generic_is_header_done, generic_unconsumed, NULL,                   NULL,         NULL,                   NULL,                    NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                             NULL,                            NULL,             generic_seg_initialize, generic_seg_txt_line, generic_assseg_line, NULL,                 generic_seg_is_small, generic_seg_finalize, NULL,                   NULL,                false,       NULL,              NULL,                     NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                  NULL,                   NULL,                NULL,                      NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                     NULL,                     NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   NUM_GENERIC_SPECIAL, GENERIC_SPECIAL, 0,               {},                 "N/A",           { "FIELD", "ERROR!", "ERROR!"         } }, \
    [DT_LOCS]  = { "LOCS",      true,  false, false,  DT_NONE,   DT_LOCS,  0,              0,                    HDR_MUST,   NULL,           -1,  locs_is_header_done,    locs_unconsumed,    NULL,                   NULL,         NULL,                   NULL,                    NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                             NULL,                            NULL,             locs_seg_initialize,    locs_seg_txt_line,    NULL,                NULL,                 locs_seg_is_small,    locs_seg_finalize,    NULL,                   NULL,                false,       NULL,              NULL,                     NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                  NULL,                   NULL,                NULL,                      NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                     NULL,                     NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   NUM_LOCS_SPECIAL,   LOCS_SPECIAL,     NUM_LOCS_TRANS,  LOCS_TRANSLATORS,   "cluster" ,      { "FIELD", "ERROR!", "ERROR!"         } }, \
...
#define DATA_TYPE_FUNCTIONS_DEFAULT /* only applicable to (some) functions */ \
                 { "DEFAULT",   false, false, false,  DT_NONE,   DT_NONE,  def_vb_size,    0,                    0,          0,              0,   def_is_header_done,     def_unconsumed,     0,                      NULL,         0,                      NULL,                    0,                 0,                   0,                     0,                 0,                         0,                    NULL,                             NULL,                            NULL,             0,                      0,                    textual_assseg_line, NULL,                 0,                    0,                    NULL,                   NULL,                false,       NULL,              NULL,                     NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   0,                     0,                      NULL,                0,                         0,                   0,                          NULL,               0,                          NULL,                     NULL,                     NULL,                     NULL,                   0,                          0,                         default_piz_filter,    0,                        0,                   0,                  {},             0,               {},                 "",              { "FIELD", "DTYPE1", "DTYPE2"         } }
...
extern rom dt_name_faf (DataType data_type);
extern rom z_dt_name (void);
extern rom z_dt_name_faf (void);
