...
/*    name         is_bin \n-end use_ref txt_type     bin_type    ht sizeof_vb       sizeof_zip_dataline   txt_headr   hdr_contigs     1st  is_header_done          unconsumed          inspect_txt_header      is_data_type  zip_initialize          zip_after_segconf  zip_after_vbs,     zip_finalize         zip_free_end_of_z      zip_init_vb        zip_after_compute          zip_dts_flag          zip_vb_has_count        zip_set_vb_header_specific        zip_set_txt_header_flags         seg_initialize          seg_txt_line          assseg_line          seg_is_big            seg_is_small          seg_finalize          zip_custom_merge seg_get_vb_recon_size      seg_modifies zip_after_compress        zip_update_txt_counters      generate_recon_plan          stats_reallocate        zip_genozip_header        piz_genozip_header        piz_after_global_area   piz_preprocess                          piz_header_init        piz_initialize          piz_finalize         piz_before_read        piz_init_vb          piz_recon_init              piz_init_line       piz_after_recon             piz_process_recon         piz_after_preproc      piz_xtra_line_data      is_skip_section             reconstruct_seq            container_filter       container_cb              con_item_cb          num_special         special         num_trans        translators         line_name        dtype_names                             */ \
    ...
    { "FASTQ",     false, true,  true,   DT_FASTQ,    DT_NONE,    4, fastq_vb_size,  fastq_vb_zip_dl_size, HDR_NONE,   NULL,           -1,  NULL,                   fastq_unconsumed,   NULL,                   is_fastq,     fastq_zip_initialize,   NULL,              NULL,              fastq_zip_finalize,  NULL,                  fastq_zip_init_vb, fastq_zip_after_compute,   NULL,                 NULL,                   NULL,                             fastq_zip_set_txt_header_flags,  fastq_seg_initialize,   fastq_seg_txt_line,   fastq_assseg_line,   NULL,                 fastq_seg_is_small,   fastq_seg_finalize,   NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   fastq_zip_genozip_header, fastq_piz_genozip_header, NULL,                   NULL,                                   fastq_piz_header_init, fastq_piz_initialize,   NULL,                fastq_piz_before_read, fastq_piz_init_vb,   NULL,                       fastq_reset_line,   NULL,                       fastq_piz_process_recon,  NULL,                  NULL,                   fastq_piz_is_skip_section,  fastq_recon_aligned_SEQ,   fastq_piz_filter,      fastq_piz_container_cb,   0,                   NUM_FASTQ_SPECIAL,  FASTQ_SPECIAL,  0,               {},                 "read",          { "FIELD", "QNAME",  "AUX"            } }, \
    { "FASTA",     false, false, false,  DT_FASTA,    DT_NONE,    1, fasta_vb_size,  fasta_vb_zip_dl_size, HDR_NONE,   NULL,           -1,  NULL,                   fasta_unconsumed,   NULL,                   is_fasta,     fasta_zip_initialize,   NULL,              NULL,              NULL,                NULL,                  NULL,              fasta_zip_after_compute,   NULL,                 NULL,                   fasta_zip_set_vb_header_specific, NULL,                            fasta_seg_initialize,   fasta_seg_txt_line,   NULL,                fasta_seg_is_big,     fasta_seg_is_small,   fasta_seg_finalize,   NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                  fasta_piz_initialize,   NULL,                NULL,                  fasta_piz_init_vb,   NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   fasta_piz_is_skip_section,  NULL,                      fasta_piz_filter,      NULL,                     0,                   NUM_FASTA_SPECIAL,  FASTA_SPECIAL,  NUM_FASTA_TRANS, FASTA_TRANSLATORS,  "line",          { "FIELD", "DESC",   "ERROR!"         } }, \
    { "GFF",       false, true,  false,  DT_GFF,      DT_NONE,    1, gff_vb_size,    0,                    HDR_OK,     NULL,           '#', NULL,                   gff_unconsumed,     gff_header_inspect,     is_gff,       gff_zip_initialize,     NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                   NULL,                             NULL,                            gff_seg_initialize,     gff_seg_txt_line,     NULL,                gff_seg_is_big,       gff_seg_is_small,     gff_seg_finalize,     NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                  NULL,                   NULL,                NULL,                  gff_piz_init_vb,     NULL,                       gff_reset_line,     NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      gff_piz_filter,        gff_piz_container_cb,     0,                   NUM_GFF_SPECIAL,    GFF_SPECIAL,    0,               {},                 "sequence",      { "FIELD", "ATTRS",  "ENST"           } }, \
    { "23ANDME",   false, true,  false,  DT_ME23,     DT_NONE,    1, 0,              0,                    HDR_MUST,   NULL,           '#', NULL,                   NULL,               me23_header_inspect,    is_me23,      NULL,                   NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                   NULL,                             NULL,                            me23_seg_initialize,    me23_seg_txt_line,    NULL,                NULL,                 me23_seg_is_small,    me23_seg_finalize,    NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                  NULL,                   NULL,                NULL,                  NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   0,                  {},             NUM_ME23_TRANS,  ME23_TRANSLATORS,   "SNP",           { "FIELD", "ERROR!", "ERROR!"         } }, \
    ...
    { "BCF",       false, true,  true,   DT_VCF,      DT_NONE,    1, vcf_vb_size,    vcf_vb_zip_dl_size,   HDR_MUST,   VCF_CONTIG_FMT, '#', NULL,                   NULL,               vcf_inspect_txt_header, NULL,         vcf_zip_initialize,     NULL,              vcf_zip_after_vbs, vcf_zip_finalize,    vcf_header_finalize,   vcf_zip_init_vb,   vcf_zip_after_compute,     NULL,                 vcf_zip_vb_has_count,   vcf_zip_set_vb_header_specific,   vcf_zip_set_txt_header_flags,    vcf_seg_initialize,     vcf_seg_txt_line,     NULL,                vcf_seg_is_big,       vcf_seg_is_small,     vcf_seg_finalize,     NULL,            vcf_seg_get_vb_recon_size, false,       vcf_zip_after_compress,   vcf_zip_update_txt_counters, vcf_zip_generate_recon_plan, NULL,                   vcf_zip_genozip_header,   vcf_piz_genozip_header,   NULL,                   NULL,                                   vcf_piz_header_init,   NULL,                   vcf_piz_finalize,    NULL,                  vcf_piz_init_vb,     vcf_piz_recon_init,         vcf_reset_line,     NULL,                       NULL,                     NULL,                  NULL,                   vcf_piz_is_skip_section,    NULL,                      vcf_piz_filter,        vcf_piz_container_cb,     vcf_piz_con_item_cb, NUM_VCF_SPECIAL,    VCF_SPECIAL,    NUM_VCF_TRANS,   VCF_TRANSLATORS,    "variant",       { "FIELD", "INFO",   "FORMAT", "BOTH" } }, \
...
#define DATA_TYPE_FUNCTIONS_DEFAULT /* only applicable to (some) functions */ \
    { "DEFAULT",   false, false, false,  DT_NONE,     DT_NONE,    0, def_vb_size,    0,                    0,          0,              0,   def_is_header_done,     def_unconsumed,     0,                      NULL,         0,                      NULL,              0,                 0,                   0,                     0,                 0,                         0,                    NULL,                   NULL,                             NULL,                            0,                      0,                    textual_assseg_line, NULL,                 0,                    0,                    NULL,            0,                         false,       NULL,                     NULL,                        0,                           NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   0,                   0,                      NULL,                0,                     0,                   0,                          NULL,               0,                          NULL,                     NULL,                  NULL,                   0,                          0,                         container_no_filter,   0,                        0,                   0,                  {},             0,               {},                 "",              { "FIELD", "DTYPE1", "DTYPE2"         } }
