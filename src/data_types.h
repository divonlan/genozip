...
#define MAX_NUM_SPECIAL MAX ((int)NUM_GNRIC_SPECIAL, \
                        ...
                        MAX ((int)NUM_GFF_SPECIAL,   \
                        MAX ((int)NUM_CHAIN_SPECIAL, \
                        MAX ((int)NUM_LOCS_SPECIAL,  \
                        MAX ((int)NUM_KRAKEN_SPECIAL,\
                        MAX ((int)NUM_BED_SPECIAL,   \
...
typedef struct DataTypeProperties {
    ...
    void (*zip_set_txt_header_specific)(SectionHeaderTxtHeaderP); // main thread from txtheader_compress: set data-type-specific fields of TXT Header
    ...
    void (*reconstruct_seq)(VBlockP, ContextP, rom , unsigned, ReconType);
...
/*    name         is_bin \n-end txt_type     bin_type    ht sizeof_vb       sizeof_zip_dataline   txt_headr   hdr_contigs     1st  is_header_done          unconsumed          inspect_txt_header      is_data_type  zip_initialize          zip_after_segconf  zip_after_vbs,     zip_finalize         zip_free_end_of_z      zip_init_vb        zip_after_compute          zip_dts_flag          zip_vb_has_count        zip_set_vb_header_specific        zip_set_txt_header_specific      seg_initialize          seg_txt_line          seg_is_big            seg_is_small          seg_finalize          zip_custom_merge seg_get_vb_recon_size      seg_modifies zip_after_compress        zip_update_txt_counters      generate_recon_plan          stats_reallocate        zip_genozip_header        piz_genozip_header        piz_after_global_area   piz_preprocess                          piz_header_init      piz_initialize          piz_finalize         piz_maybe_reorder_lines        piz_init_vb          piz_recon_init              piz_init_line       piz_after_recon             piz_process_recon         piz_after_preproc      piz_xtra_line_data      is_skip_section             reconstruct_seq            container_filter       container_cb              con_item_cb          num_special         special         num_trans        translators         release_vb            destroy_vb           line_name        dtype_names                             */ \
    { "REFERENCE", false, false, DT_REF,      DT_NONE,    1, fasta_vb_size,  fasta_vb_zip_dl_size, HDR_NONE,   NULL,           -1,  NULL,                   fasta_unconsumed,   NULL,                   is_ref,       ref_make_ref_init,      NULL,              NULL,              ref_make_finalize,   NULL,                  NULL,              ref_make_after_compute,    NULL,                 NULL,                   NULL,                             NULL,                            ref_make_seg_initialize,fasta_seg_txt_line,   NULL,                 fasta_seg_is_small,   fasta_seg_finalize,   NULL,            NULL,                      false,       ref_make_create_range,    NULL,                        NULL,                        NULL,                   ref_make_genozip_header,  NULL,                     NULL,                   NULL,                                   NULL,                NULL,                   NULL,                NULL,                          NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      NULL,                  0,                        0,                   0,                  {},             0,               {},                 fasta_vb_release_vb,  NULL,                "Line",          { "FIELD", "DESC",   "ERROR!"         } }, \
    { "VCF",       false, true,  DT_VCF,      DT_NONE,    1, vcf_vb_size,    vcf_vb_zip_dl_size,   HDR_MUST,   VCF_CONTIG_FMT, '#', NULL,                   NULL,               vcf_inspect_txt_header, is_vcf,       vcf_zip_initialize,     NULL,              vcf_zip_after_vbs, vcf_zip_finalize,    vcf_header_finalize,   vcf_zip_init_vb,   vcf_zip_after_compute,     NULL,                 vcf_zip_vb_has_count,   vcf_zip_set_vb_header_specific,   vcf_zip_set_txt_header_specific, vcf_seg_initialize,     vcf_seg_txt_line,     vcf_seg_is_big,       vcf_seg_is_small,     vcf_seg_finalize,     NULL,            vcf_seg_get_vb_recon_size, false,       vcf_zip_after_compress,   vcf_zip_update_txt_counters, vcf_zip_generate_recon_plan, NULL,                   vcf_zip_genozip_header,   vcf_piz_genozip_header,   NULL,                   NULL,                                   vcf_header_piz_init, NULL,                   vcf_piz_finalize,    vcf_piz_maybe_reorder_lines,   vcf_piz_init_vb,     vcf_piz_recon_init,         vcf_reset_line,     NULL,                       NULL,                     NULL,                  NULL,                   vcf_piz_is_skip_section,    NULL,                      vcf_piz_filter,        vcf_piz_container_cb,     vcf_piz_con_item_cb, NUM_VCF_SPECIAL,    VCF_SPECIAL,    NUM_VCF_TRANS,   VCF_TRANSLATORS,    vcf_vb_release_vb,    vcf_vb_destroy_vb,     "Variant",       { "FIELD", "INFO",   "FORMAT", "BOTH" } }, \
    { "SAM",       false, true,  DT_SAM,      DT_BAM,     1, sam_vb_size,    sam_vb_zip_dl_size,   HDR_OK_0,   SAM_CONTIG_FMT, '@', NULL,                   NULL,               sam_header_inspect,     is_sam,       sam_zip_initialize,     sam_set_sag_type,  sam_zip_after_vbs, sam_zip_finalize,    sam_zip_free_end_of_z, sam_zip_init_vb,   sam_zip_after_compute,     sam_zip_dts_flag,     NULL,                   sam_zip_set_vb_header_specific,   NULL,                            sam_seg_initialize,     sam_seg_txt_line,     sam_seg_is_big,       sam_seg_is_small,     sam_seg_finalize,     sam_deep_merge,  NULL,                      false,       sam_zip_after_compress,   NULL,                        sam_zip_generate_recon_plan, sam_stats_reallocate,   sam_zip_genozip_header,   sam_piz_genozip_header,   sam_piz_load_sags,      sam_piz_dispatch_one_load_sag_vb,       NULL,                sam_piz_initialize,     sam_piz_finalize,    sam_piz_maybe_reorder_lines,   sam_piz_init_vb,     sam_piz_recon_init,         sam_reset_line,     sam_piz_after_recon,        sam_piz_process_recon,    sam_piz_after_preproc, sam_piz_xtra_line_data, sam_piz_is_skip_section,    sam_reconstruct_SEQ_vs_ref,sam_piz_filter,        sam_piz_container_cb,     sam_piz_con_item_cb, NUM_SAM_SPECIAL,    SAM_SPECIAL,    NUM_SAM_TRANS,   SAM_TRANSLATORS,    sam_vb_release_vb,    sam_vb_destroy_vb,   "Alignment",     { "FIELD", "QNAME",  "OPTION"         } }, \
    { "FASTQ",     false, true,  DT_FASTQ,    DT_NONE,    4, fastq_vb_size,  fastq_vb_zip_dl_size, HDR_NONE,   NULL,           -1,  NULL,                   fastq_unconsumed,   NULL,                   is_fastq,     fastq_zip_initialize,   NULL,              NULL,              fastq_zip_finalize,  NULL,                  fastq_zip_init_vb, fastq_zip_after_compute,   fastq_zip_dts_flag,   NULL,                   NULL,                             NULL,                            fastq_seg_initialize,   fastq_seg_txt_line,   NULL,                 fastq_seg_is_small,   fastq_seg_finalize,   NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   fastq_zip_genozip_header, fastq_piz_genozip_header, NULL,                   NULL,                                   NULL,                NULL,                   NULL,                fastq_piz_maybe_reorder_lines, fastq_piz_init_vb,   NULL,                       fastq_reset_line,   NULL,                       fastq_piz_process_recon,  NULL,                  NULL,                   fastq_piz_is_skip_section,  fastq_recon_aligned_SEQ,   fastq_piz_filter,      fastq_piz_container_cb,   0,                   NUM_FASTQ_SPECIAL,  FASTQ_SPECIAL,  0,               {},                 fastq_vb_release_vb,  fastq_vb_destroy_vb, "Sequence",      { "FIELD", "QNAME",  "AUX"            } }, \
    { "FASTA",     false, false, DT_FASTA,    DT_NONE,    1, fasta_vb_size,  fasta_vb_zip_dl_size, HDR_NONE,   NULL,           -1,  NULL,                   fasta_unconsumed,   NULL,                   is_fasta,     fasta_zip_initialize,   NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                   fasta_zip_set_vb_header_specific, NULL,                            fasta_seg_initialize,   fasta_seg_txt_line,   fasta_seg_is_big,     fasta_seg_is_small,   fasta_seg_finalize,   NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                NULL,                   NULL,                NULL,                          fasta_piz_init_vb,   NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   fasta_piz_is_skip_section,  NULL,                      fasta_piz_filter,      NULL,                     0,                   NUM_FASTA_SPECIAL,  FASTA_SPECIAL,  NUM_FASTA_TRANS, FASTA_TRANSLATORS,  fasta_vb_release_vb,  fasta_vb_destroy_vb, "Line",          { "FIELD", "DESC",   "ERROR!"         } }, \
    { "GFF",       false, true,  DT_GFF,      DT_NONE,    1, gff_vb_size,    0,                    HDR_OK,     NULL,           '#', NULL,                   gff_unconsumed,     gff_header_inspect,     is_gff,       gff_zip_initialize,     NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                   NULL,                             NULL,                            gff_seg_initialize,     gff_seg_txt_line,     NULL,                 gff_seg_is_small,     gff_seg_finalize,     NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                NULL,                   NULL,                NULL,                          gff_piz_init_vb,     NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      gff_piz_filter,        gff_piz_container_cb,     0,                   NUM_GFF_SPECIAL,    GFF_SPECIAL,    0,               {},                 gff_vb_release_vb,    NULL,                "Sequence",      { "FIELD", "ATTRS",  "ENST"           } }, \
    { "23ANDME",   false, true,  DT_ME23,     DT_NONE,    1, 0,              0,                    HDR_MUST,   NULL,           '#', NULL,                   NULL,               me23_header_inspect,    is_me23,      NULL,                   NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                   NULL,                             NULL,                            me23_seg_initialize,    me23_seg_txt_line,    NULL,                 me23_seg_is_small,    me23_seg_finalize,    NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                NULL,                   NULL,                NULL,                          NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   0,                  {},             NUM_ME23_TRANS,  ME23_TRANSLATORS,   NULL,                 NULL,                "SNP",           { "FIELD", "ERROR!", "ERROR!"         } }, \
    { "BAM",       true,  false, DT_SAM,      DT_NONE,    0, sam_vb_size,    sam_vb_zip_dl_size,   HDR_MUST_0, SAM_CONTIG_FMT, -1,  bam_is_header_done,     bam_unconsumed,     sam_header_inspect,     is_bam,       sam_zip_initialize,     sam_set_sag_type,  sam_zip_after_vbs, sam_zip_finalize,    sam_zip_free_end_of_z, sam_zip_init_vb,   sam_zip_after_compute,     sam_zip_dts_flag,     NULL,                   sam_zip_set_vb_header_specific,   NULL,                            bam_seg_initialize,     bam_seg_txt_line,     sam_seg_is_big,       sam_seg_is_small,     sam_seg_finalize,     sam_deep_merge,  NULL,                      true,        sam_zip_after_compress,   NULL,                        sam_zip_generate_recon_plan, sam_stats_reallocate,   sam_zip_genozip_header,   sam_piz_genozip_header,   sam_piz_load_sags,      sam_piz_dispatch_one_load_sag_vb,       NULL,                sam_piz_initialize,     sam_piz_finalize,    sam_piz_maybe_reorder_lines,   sam_piz_init_vb,     sam_piz_recon_init,         sam_reset_line,     sam_piz_after_recon,        sam_piz_process_recon,    sam_piz_after_preproc, sam_piz_xtra_line_data, NULL,                       NULL,                      sam_piz_filter,        sam_piz_container_cb,     0/*cb only in SAM*/, NUM_SAM_SPECIAL,    SAM_SPECIAL,    NUM_SAM_TRANS,   SAM_TRANSLATORS,    sam_vb_release_vb,    sam_vb_destroy_vb,   "Alignment",     { "FIELD", "DESC",   "OPTION"         } }, \
    { "BCF",       false, true,  DT_VCF,      DT_NONE,    1, vcf_vb_size,    vcf_vb_zip_dl_size,   HDR_MUST,   VCF_CONTIG_FMT, '#', NULL,                   NULL,               vcf_inspect_txt_header, NULL,         vcf_zip_initialize,     NULL,              vcf_zip_after_vbs, vcf_zip_finalize,    vcf_header_finalize,   vcf_zip_init_vb,   vcf_zip_after_compute,     NULL,                 vcf_zip_vb_has_count,   vcf_zip_set_vb_header_specific,   vcf_zip_set_txt_header_specific, vcf_seg_initialize,     vcf_seg_txt_line,     vcf_seg_is_big,       vcf_seg_is_small,     vcf_seg_finalize,     NULL,            vcf_seg_get_vb_recon_size, false,       vcf_zip_after_compress,   vcf_zip_update_txt_counters, vcf_zip_generate_recon_plan, NULL,                   vcf_zip_genozip_header,   vcf_piz_genozip_header,   NULL,                   NULL,                                   vcf_header_piz_init, NULL,                   vcf_piz_finalize,    vcf_piz_maybe_reorder_lines,   vcf_piz_init_vb,     vcf_piz_recon_init,         vcf_reset_line,     NULL,                       NULL,                     NULL,                  NULL,                   vcf_piz_is_skip_section,    NULL,                      vcf_piz_filter,        vcf_piz_container_cb,     vcf_piz_con_item_cb, NUM_VCF_SPECIAL,    VCF_SPECIAL,    NUM_VCF_TRANS,   VCF_TRANSLATORS,    vcf_vb_release_vb,    vcf_vb_destroy_vb,     "Variant",       { "FIELD", "INFO",   "FORMAT", "BOTH" } }, \
    { "GENERIC",   true,  false, DT_GENERIC,  DT_GENERIC, 0, 0,              0,                    HDR_OK,     NULL,           -1,  generic_is_header_done, generic_unconsumed, NULL,                   NULL,         NULL,                   NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                   NULL,                             NULL,                            generic_seg_initialize, NULL,                 NULL,                 generic_seg_is_small, generic_seg_finalize, NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                NULL,                   NULL,                NULL,                          NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   NUM_GNRIC_SPECIAL,  GNRIC_SPECIAL,  0,               {},                 NULL,                 NULL,                "N/A",           { "FIELD", "ERROR!", "ERROR!"         } }, \
    { "PHYLIP",    false, true,  DT_PHYLIP,   DT_NONE,    1, 0,              phy_vb_zip_dl_size,   HDR_MUST,   NULL,           -1,  phy_is_header_done,     NULL,               phy_header_inspect,     NULL,         NULL,                   NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                   NULL,                             NULL,                            phy_seg_initialize,     phy_seg_txt_line,     NULL,                 phy_seg_is_small,     phy_seg_finalize,     NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                NULL,                   NULL,                NULL,                          NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   0,                  {},             NUM_PHYLIP_TRANS,PHYLIP_TRANSLATORS, NULL,                 NULL,                "Sequence",      { "FIELD", "ERROR!", "ERROR!"         } }, \
    { "CHAIN",     false, true,  DT_CHAIN,    DT_NONE,    1, chain_vb_size,  0,                    HDR_NONE,   NULL,           -1,  NULL,                   chain_unconsumed,   NULL,                   NULL,         chain_zip_initialize,   NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      chain_zip_dts_flag,   NULL,                   NULL,                             NULL,                            chain_seg_initialize,   chain_seg_txt_line,   NULL,                 chain_seg_is_small,   chain_seg_finalize,   NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   chain_zip_genozip_header, NULL,                     NULL,                   NULL,                                   NULL,                chain_piz_initialize,   NULL,                NULL,                          NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      chain_piz_filter,      NULL,                     0,                   NUM_CHAIN_SPECIAL,  CHAIN_SPECIAL,  0,               {},                 chain_vb_release_vb,  NULL,                "Alignment set", { "FIELD", "ERROR!", "ERROR!"         } }, \
    { "KRAKEN",    false, true,  DT_KRAKEN,   DT_NONE,    1, kraken_vb_size, 0,                    HDR_NONE,   NULL,           -1,  NULL,                   NULL,               NULL,                   NULL,         kraken_zip_initialize,  NULL,              NULL,              NULL,                NULL,                  NULL,              kraken_zip_after_compute,  NULL,                 NULL,                   NULL,                             NULL,                            kraken_seg_initialize,  kraken_seg_txt_line,  NULL,                 kraken_seg_is_small,  kraken_seg_finalize,  NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                kraken_piz_initialize,  NULL,                NULL,                          NULL,                NULL,                       NULL,               NULL,                       kraken_piz_process_recon, NULL,                  NULL,                   kraken_piz_is_skip_section, NULL,                      NULL,                  kraken_piz_container_cb,  0,                   NUM_KRAKEN_SPECIAL, KRAKEN_SPECIAL, 0,               {},                 kraken_vb_release_vb, NULL,                "Sequence",      { "FIELD", "QNAME",  "SEQLEN"         } }, \
    { "LOCS",      true,  false, DT_NONE,     DT_LOCS,    0, 0,              0,                    HDR_MUST,   NULL,           -1,  locs_is_header_done,    locs_unconsumed,    NULL,                   NULL,         NULL,                   NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                   NULL,                             NULL,                            locs_seg_initialize,    locs_seg_txt_line,    NULL,                 locs_seg_is_small,    locs_seg_finalize,    NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                NULL,                   NULL,                NULL,                          NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   NUM_LOCS_SPECIAL,   LOCS_SPECIAL,   NUM_LOCS_TRANS,  LOCS_TRANSLATORS,   NULL,                 NULL,                "Cluster" ,      { "FIELD", "ERROR!", "ERROR!"         } }, \
    { "BED",       false, true,  DT_BED,      DT_NONE,    1, 0,              0,                    HDR_OK,     NULL,           -1,  bed_is_header_done,     NULL,               NULL,                   is_bed,       bed_zip_initialize,     NULL,              NULL,              NULL,                NULL,                  NULL,              NULL,                      NULL,                 NULL,                   NULL,                             NULL,                            bed_seg_initialize,     bed_seg_txt_line,     NULL,                 bed_seg_is_small,     bed_seg_finalize,     NULL,            NULL,                      false,       NULL,                     NULL,                        NULL,                        NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   NULL,                NULL,                   NULL,                NULL,                          NULL,                NULL,                       NULL,               NULL,                       NULL,                     NULL,                  NULL,                   NULL,                       NULL,                      NULL,                  NULL,                     0,                   NUM_BED_SPECIAL,    BED_SPECIAL,    0,               {},                 NULL,                 NULL,                "Line",          { "FIELD", "ERROR!", "ERROR!"         } }, \
}  
#define DATA_TYPE_FUNCTIONS_DEFAULT /* only applicable to (some) functions */ \
    { "DEFAULT",   false, false, DT_NONE,     DT_NONE,    0, def_vb_size,    0,                    0,          0,              0,   def_is_header_done,     def_unconsumed,     0,                      NULL,         0,                      NULL,              0,                 0,                   0,                     0,                 0,                         0,                    NULL,                   NULL,                             NULL,                            0,                      0,                    NULL,                 0,                    0,                    NULL,            0,                         false,       NULL,                     NULL,                        0,                           NULL,                   NULL,                     NULL,                     NULL,                   NULL,                                   0,                   0,                      NULL,                NULL,                          0,                   0,                          NULL,               0,                          NULL,                     NULL,                  NULL,                   0,                          0,                         container_no_filter,   0,                        0,                   0,                  {},             0,               {},                 0,                    0,                   "",              {                                     } }
