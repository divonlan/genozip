...
#define profiled \
        ...
        codec_domq_reconstruct, codec_domq_reconstruct_dom_run, codec_longr_reconstruct, codec_homp_reconstruct, codec_t0_reconstruct, \
        ...
        fastq_seg_deep, fastq_seg_DESC, fastq_seg_saux, fastq_seg_deep_consume_unique_matching_ent,\
