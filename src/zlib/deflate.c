...
/* ========================================================================= */
static int ZEXPORT deflateResetKeep (strm)
    z_streamp strm;
{
    deflate_state *s;
    ...
    int stream_size;
{
    ...
    memset (s->prev, 0, s->w_size * sizeof(Pos)); // divon: added this bc valgrind sometimes shouts about use of uninitiazed value (in level=1)
