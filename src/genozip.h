...
// ------------------------------------------------------------------------------------------------------------------------
typedef struct VBlock *VBlockP, *restrict VBlockរ;
...
typedef struct Buffer *restrict Bufferរ;
...
typedef const char *restrict romរ;      
...
#define STRpរ(x) romរ x,       uint32_t x##_len    
