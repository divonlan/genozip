...
// ------------------------------------------------------------------------------------------------------------------------
typedef struct VBlock *VBlockP, *restrict VBlock𐤐;
...
typedef struct ContainerTemplate *ContainerP;
typedef const struct ContainerTemplate *ConstContainerP;
typedef const struct ContainerTemplate *restrict ConstContainer𐤐;
...
typedef struct Context *restrict Context𐤐;
...
typedef struct Bits *restrict Bits𐤐;
typedef const struct Bits *restrict ConstBits𐤐;
...
extern void noreturn error_assertinp_failed (rom format, ...);
extern void noreturn error_assert_failed (FUNCLINE, rom format, ...);
