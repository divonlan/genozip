...
#define MAX_FIELDS 2048  // Maximum number of fields in a line (eg VCF variant, SAM alignment etc), including VCF/FORMAT fields, VCF/INFO fields GVF/ATTR fields, SAM/AUX fields etc. 
...
#define MAX_QNAME_ITEMS 18 // mate + normal : in changing, update Q?NAME in sam.h, fasta.h, gff.h
...
typedef enum { NO_COMMAND=-1, ZIP='z', PIZ='d' /* this is unzip */, LIST='l', LICENSE='L', VERSION='V', HELP=140, SHOW_HEADERS=10, BIOPSY_BYTES=148, SHOW_BAI=11, GENERATE_IL1M=153, SHOW_FLAVOR=156, SHOW_GZ=157, DUMP_GZ_BLOCK=158, RM_CACHE=256, TEST_AFTER_ZIP } CommandType; 
...
#define IS_BIOPSY_BYTES  (command == BIOPSY_BYTES)
