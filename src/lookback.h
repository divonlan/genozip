...
extern void lookback_insert_container (VBlockP vb, ContainerP con, unsigned num_items, ContextP *item_ctxs);
...
extern void lookback_flush (VBlockP vb, ContainerP con);
