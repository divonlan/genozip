...
#define _UNUSED_FASTQ_QNAME2 ((uint64_t)55273230257873)
...
#define _UNUSED_FASTQ_COPY_Q ((uint64_t)133523812078068)
...
#define _FASTQ_DESC ((uint64_t)297648868881)
...
#define SAM_PREDEFINED { \
    ...
    [UNUSED_FASTQ_COPY_Q] = { { _UNUSED_FASTQ_COPY_Q }, TAG(tQcopy) }, \
...
typedef enum { FASTQ_CONTIG, FASTQ_DESC, FASTQ_Q0NAME, FASTQ_Q1NAME, FASTQ_Q2NAME, FASTQ_Q3NAME, FASTQ_Q4NAME, FASTQ_Q5NAME, FASTQ_Q6NAME, FASTQ_Q7NAME, FASTQ_Q8NAME, FASTQ_Q9NAME, FASTQ_QANAME, FASTQ_QBNAME, FASTQ_QmNAME, FASTQ_SQBITMAP, FASTQ_NONREF, FASTQ_NONREF_X, FASTQ_GPOS, FASTQ_STRAND, FASTQ_SEQMIS_A, FASTQ_SEQMIS_C, FASTQ_SEQMIS_G, FASTQ_SEQMIS_T, FASTQ_QUAL, FASTQ_DOMQRUNS, FASTQ_QUALMPLX, FASTQ_DIVRQUAL, FASTQ_TOPLEVEL, FASTQ_BUDDY, FASTQ_TAXID, FASTQ_DEBUG_LINES, FASTQ_DEEP, FASTQ_QNAME2, FASTQ_Q0NAME2, FASTQ_Q1NAME2, FASTQ_Q2NAME2, FASTQ_Q3NAME2, FASTQ_Q4NAME2, FASTQ_Q5NAME2, FASTQ_Q6NAME2, FASTQ_Q7NAME2, FASTQ_Q8NAME2, FASTQ_Q9NAME2, FASTQ_QANAME2, FASTQ_QBNAME2, FASTQ_E1L, FASTQ_E2L, FASTQ_LINE3, FASTQ_T0HIRD, FASTQ_T1HIRD, FASTQ_T2HIRD, FASTQ_T3HIRD, FASTQ_T4HIRD, FASTQ_T5HIRD, FASTQ_T6HIRD, FASTQ_T7HIRD, FASTQ_T8HIRD, FASTQ_T9HIRD, FASTQ_TAHIRD, FASTQ_TBHIRD, FASTQ_COPY_Q, NUM_FASTQ_FIELDS } FASTQFields;

#define FASTQ_PREDEFINED { \
    [FASTQ_CONTIG] = { { _FASTQ_CONTIG }, TAG(CONTIG) }, \
    [FASTQ_DESC] = { { _FASTQ_DESC }, TAG(QNAME) }, \
...
#define MAX_NUM_FIELDS_PER_DATA_TYPE 346
