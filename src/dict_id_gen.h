...
#define _KRAKEN_QCNAME ((uint64_t)76198110446545)
#define _KRAKEN_QDNAME ((uint64_t)76198110446801)
#define _KRAKEN_QENAME ((uint64_t)76198110447057)
...
#define KRAKEN_PREDEFINED { \
    ...
    [KRAKEN_QCNAME] = { { _KRAKEN_QCNAME }, TAG(QCNAME) }, \
    [KRAKEN_QDNAME] = { { _KRAKEN_QDNAME }, TAG(QDNAME) }, \
    [KRAKEN_QENAME] = { { _KRAKEN_QENAME }, TAG(QENAME) }, \
