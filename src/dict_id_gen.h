...
#define _UNUSED_FASTQ_DEEP_VB ((uint64_t)1112961028)
#define _UNUSED_FASTQ_DEEP_LINE ((uint64_t)76202539511812)
...
#define _FASTQ_DEEP ((uint64_t)1112961028)
#define _FASTQ_DEEP_LINE ((uint64_t)76202539511812)
...
#define SAM_PREDEFINED { \
    ...
    [UNUSED_FASTQ_DEEP_VB] = { { _UNUSED_FASTQ_DEEP_VB }, TAG(DpVB) }, \
    [UNUSED_FASTQ_DEEP_LINE] = { { _UNUSED_FASTQ_DEEP_LINE }, TAG(DpLINE) }, \
...
#define FASTQ_PREDEFINED { \
    ...
    [FASTQ_DEEP] = { { _FASTQ_DEEP }, TAG(DpVB) }, \
    [FASTQ_DEEP_LINE] = { { _FASTQ_DEEP_LINE }, TAG(DpLINE) }, \
...
#define MAX_NUM_FIELDS_PER_DATA_TYPE 339
