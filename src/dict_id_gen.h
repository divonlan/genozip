...
#define _SAM_QFNAME ((uint64_t)76198110447313)
#define _SAM_QGNAME ((uint64_t)76198110447569)
...
#define _FASTA_QFNAME ((uint64_t)76198110447313)
#define _FASTA_QGNAME ((uint64_t)76198110447569)
...
#define _GFF_FASTA_QFNAME ((uint64_t)76198110447313)
#define _GFF_FASTA_QGNAME ((uint64_t)76198110447569)
...
#define SAM_PREDEFINED { \
    ...
    [SAM_QFNAME] = { { _SAM_QFNAME }, TAG(QFNAME) }, \
    [SAM_QGNAME] = { { _SAM_QGNAME }, TAG(QGNAME) }, \
...
typedef enum { FASTA_CONTIG, FASTA_QNAME, FASTA_Q0NAME, FASTA_Q1NAME, FASTA_Q2NAME, FASTA_Q3NAME, FASTA_Q4NAME, FASTA_Q5NAME, FASTA_Q6NAME, FASTA_Q7NAME, FASTA_Q8NAME, FASTA_Q9NAME, FASTA_QANAME, FASTA_QBNAME, FASTA_QCNAME, FASTA_QDNAME, FASTA_QENAME, FASTA_QFNAME, FASTA_QGNAME, FASTA_QmNAME, FASTA_LINEMETA, FASTA_EOL, FASTA_DESC, FASTA_COMMENT, FASTA_NONREF, FASTA_NONREF_X, FASTA_TOPLEVEL, FASTA_TAXID, FASTA_DEBUG_LINES, NUM_FASTA_FIELDS } FASTAFields;
...
#define FASTA_PREDEFINED { \
    ...
    [FASTA_QFNAME] = { { _FASTA_QFNAME }, TAG(QFNAME) }, \
    [FASTA_QGNAME] = { { _FASTA_QGNAME }, TAG(QGNAME) }, \
...
#define GFF_PREDEFINED { \
    ...
    [GFF_FASTA_QFNAME] = { { _GFF_FASTA_QFNAME }, TAG(QFNAME) }, \
    [GFF_FASTA_QGNAME] = { { _GFF_FASTA_QGNAME }, TAG(QGNAME) }, \
