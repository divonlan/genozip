...
#define _VCF_DEBUG_LINES ((uint64_t)3400027800785601028)
...
#define _INFO_RAW_MQandDP ((uint64_t)3400024498275566034)
...
#define _INFO_ILLUMINA_STRAND ((uint64_t)3400011346917215433)
...
#define MAX_NUM_FIELDS_PER_DATA_TYPE 356
