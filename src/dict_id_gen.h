...
#define _DEEP_FASTQ_QNAME2 ((uint64_t)55273230257681)
#define _DEEP_FASTQ_Q0NAME2 ((uint64_t)76198110441713)
#define _DEEP_FASTQ_Q1NAME2 ((uint64_t)76198110441969)
#define _DEEP_FASTQ_Q2NAME2 ((uint64_t)76198110442225)
#define _DEEP_FASTQ_Q3NAME2 ((uint64_t)76198110442481)
#define _DEEP_FASTQ_Q4NAME2 ((uint64_t)76198110442737)
#define _DEEP_FASTQ_Q5NAME2 ((uint64_t)76198110442993)
#define _DEEP_FASTQ_Q6NAME2 ((uint64_t)76198110443249)
#define _DEEP_FASTQ_Q7NAME2 ((uint64_t)76198110443505)
#define _DEEP_FASTQ_Q8NAME2 ((uint64_t)76198110443761)
#define _DEEP_FASTQ_Q9NAME2 ((uint64_t)76198110444017)
#define _DEEP_FASTQ_QANAME2 ((uint64_t)76198110446065)
#define _DEEP_FASTQ_QBNAME2 ((uint64_t)76198110446321)
#define _DEEP_FASTQ_QCNAME2 ((uint64_t)76198110446577)
#define _DEEP_FASTQ_QDNAME2 ((uint64_t)76198110446833)
#define _DEEP_FASTQ_QeNAME2 ((uint64_t)76198110447089)
#define _DEEP_FASTQ_QmNAME2 ((uint64_t)76198110457329)
#define _DEEP_FASTQ_EXTRA ((uint64_t)1129530820)
...
#define _DEEP_FASTQ_DEEP ((uint64_t)1346716932)
#define _DEEP_FASTQ_DEEP_DELTA ((uint64_t)344759545860)
#define _DEEP_FASTQ_E1L ((uint64_t)4993285)
#define _DEEP_FASTQ_E2L ((uint64_t)4993541)
#define _DEEP_FASTQ_LINE3 ((uint64_t)220206090508)
#define _DEEP_FASTQ_T0HIRD ((uint64_t)76198110441716)
#define _DEEP_FASTQ_T1HIRD ((uint64_t)76198110441972)
#define _DEEP_FASTQ_T2HIRD ((uint64_t)76198110442228)
#define _DEEP_FASTQ_T3HIRD ((uint64_t)76198110442484)
#define _DEEP_FASTQ_T4HIRD ((uint64_t)76198110442740)
#define _DEEP_FASTQ_T5HIRD ((uint64_t)76198110442996)
#define _DEEP_FASTQ_T6HIRD ((uint64_t)76198110443252)
#define _DEEP_FASTQ_T7HIRD ((uint64_t)76198110443508)
#define _DEEP_FASTQ_T8HIRD ((uint64_t)76198110443764)
#define _DEEP_FASTQ_T9HIRD ((uint64_t)76198110444020)
#define _DEEP_FASTQ_TAHIRD ((uint64_t)76198110446068)
#define _DEEP_FASTQ_TBHIRD ((uint64_t)76198110446324)
#define _DEEP_FASTQ_TCHIRD ((uint64_t)76198110446580)
#define _DEEP_FASTQ_TDHIRD ((uint64_t)76198110446836)
#define _DEEP_FASTQ_TEHIRD ((uint64_t)76198110447092)
#define _DEEP_FASTQ_TmHIRD ((uint64_t)76198110457332)
#define _DEEP_FASTQ_AUX_LENGTH ((uint64_t)114849160783212)
...
#define _FASTQ_QNAME ((uint64_t)297648868881)
...
#define _FASTQ_QCNAME ((uint64_t)76198110446545)
#define _FASTQ_QDNAME ((uint64_t)76198110446801)
#define _FASTQ_QENAME ((uint64_t)76198110447057)
#define _FASTQ_QmNAME ((uint64_t)76198110457297)
#define _FASTQ_QNAME2 ((uint64_t)55273230257681)
...
#define _FASTQ_QCNAME2 ((uint64_t)76198110446577)
#define _FASTQ_QDNAME2 ((uint64_t)76198110446833)
#define _FASTQ_QENAME2 ((uint64_t)76198110447089)
#define _FASTQ_QmNAME2 ((uint64_t)76198110457329)
#define _FASTQ_EXTRA ((uint64_t)1129530820)
#define _FASTQ_AUX ((uint64_t)5788929)
...
#define _FASTQ_GPOS_DELTA ((uint64_t)357812940807)
...
#define _FASTQ_BUDDY ((uint64_t)383397418242)
...
#define SAM_PREDEFINED { \
    ...
    [DEEP_FASTQ_QNAME2] = { { _DEEP_FASTQ_QNAME2 }, TAG(QNAME2) }, \
    [DEEP_FASTQ_Q0NAME2] = { { _DEEP_FASTQ_Q0NAME2 }, TAG(q0NAME) }, \
    [DEEP_FASTQ_Q1NAME2] = { { _DEEP_FASTQ_Q1NAME2 }, TAG(q1NAME) }, \
    [DEEP_FASTQ_Q2NAME2] = { { _DEEP_FASTQ_Q2NAME2 }, TAG(q2NAME) }, \
    [DEEP_FASTQ_Q3NAME2] = { { _DEEP_FASTQ_Q3NAME2 }, TAG(q3NAME) }, \
    [DEEP_FASTQ_Q4NAME2] = { { _DEEP_FASTQ_Q4NAME2 }, TAG(q4NAME) }, \
    [DEEP_FASTQ_Q5NAME2] = { { _DEEP_FASTQ_Q5NAME2 }, TAG(q5NAME) }, \
    [DEEP_FASTQ_Q6NAME2] = { { _DEEP_FASTQ_Q6NAME2 }, TAG(q6NAME) }, \
    [DEEP_FASTQ_Q7NAME2] = { { _DEEP_FASTQ_Q7NAME2 }, TAG(q7NAME) }, \
    [DEEP_FASTQ_Q8NAME2] = { { _DEEP_FASTQ_Q8NAME2 }, TAG(q8NAME) }, \
    [DEEP_FASTQ_Q9NAME2] = { { _DEEP_FASTQ_Q9NAME2 }, TAG(q9NAME) }, \
    [DEEP_FASTQ_QANAME2] = { { _DEEP_FASTQ_QANAME2 }, TAG(qANAME) }, \
    [DEEP_FASTQ_QBNAME2] = { { _DEEP_FASTQ_QBNAME2 }, TAG(qBNAME) }, \
    [DEEP_FASTQ_QCNAME2] = { { _DEEP_FASTQ_QCNAME2 }, TAG(qCNAME) }, \
    [DEEP_FASTQ_QDNAME2] = { { _DEEP_FASTQ_QDNAME2 }, TAG(qDNAME) }, \
    [DEEP_FASTQ_QeNAME2] = { { _DEEP_FASTQ_QeNAME2 }, TAG(qENAME) }, \
    [DEEP_FASTQ_QmNAME2] = { { _DEEP_FASTQ_QmNAME2 }, TAG(qmNAME) }, \
    [DEEP_FASTQ_EXTRA] = { { _DEEP_FASTQ_EXTRA }, TAG(DESC) }, \
    ...
    [DEEP_FASTQ_DEEP] = { { _DEEP_FASTQ_DEEP }, TAG(DEEP) }, \
    [DEEP_FASTQ_DEEP_DELTA] = { { _DEEP_FASTQ_DEEP_DELTA }, TAG(D0EEP) }, \
    [DEEP_FASTQ_E1L] = { { _DEEP_FASTQ_E1L }, TAG(E1L) }, \
    [DEEP_FASTQ_E2L] = { { _DEEP_FASTQ_E2L }, TAG(E2L) }, \
    [DEEP_FASTQ_LINE3] = { { _DEEP_FASTQ_LINE3 }, TAG(LINE3) }, \
    [DEEP_FASTQ_T0HIRD] = { { _DEEP_FASTQ_T0HIRD }, TAG(t0NAME) }, \
    [DEEP_FASTQ_T1HIRD] = { { _DEEP_FASTQ_T1HIRD }, TAG(t1NAME) }, \
    [DEEP_FASTQ_T2HIRD] = { { _DEEP_FASTQ_T2HIRD }, TAG(t2NAME) }, \
    [DEEP_FASTQ_T3HIRD] = { { _DEEP_FASTQ_T3HIRD }, TAG(t3NAME) }, \
    [DEEP_FASTQ_T4HIRD] = { { _DEEP_FASTQ_T4HIRD }, TAG(t4NAME) }, \
    [DEEP_FASTQ_T5HIRD] = { { _DEEP_FASTQ_T5HIRD }, TAG(t5NAME) }, \
    [DEEP_FASTQ_T6HIRD] = { { _DEEP_FASTQ_T6HIRD }, TAG(t6NAME) }, \
    [DEEP_FASTQ_T7HIRD] = { { _DEEP_FASTQ_T7HIRD }, TAG(t7NAME) }, \
    [DEEP_FASTQ_T8HIRD] = { { _DEEP_FASTQ_T8HIRD }, TAG(t8NAME) }, \
    [DEEP_FASTQ_T9HIRD] = { { _DEEP_FASTQ_T9HIRD }, TAG(t9NAME) }, \
    [DEEP_FASTQ_TAHIRD] = { { _DEEP_FASTQ_TAHIRD }, TAG(tANAME) }, \
    [DEEP_FASTQ_TBHIRD] = { { _DEEP_FASTQ_TBHIRD }, TAG(tBNAME) }, \
    [DEEP_FASTQ_TCHIRD] = { { _DEEP_FASTQ_TCHIRD }, TAG(tCNAME) }, \
    [DEEP_FASTQ_TDHIRD] = { { _DEEP_FASTQ_TDHIRD }, TAG(tDNAME) }, \
    [DEEP_FASTQ_TEHIRD] = { { _DEEP_FASTQ_TEHIRD }, TAG(tENAME) }, \
    [DEEP_FASTQ_TmHIRD] = { { _DEEP_FASTQ_TmHIRD }, TAG(tmNAME) }, \
    [DEEP_FASTQ_AUX_LENGTH] = { { _DEEP_FASTQ_AUX_LENGTH }, TAG(length) }, \
...
typedef enum { FASTQ_CONTIG, FASTQ_QNAME, FASTQ_Q0NAME, FASTQ_Q1NAME, FASTQ_Q2NAME, FASTQ_Q3NAME, FASTQ_Q4NAME, FASTQ_Q5NAME, FASTQ_Q6NAME, FASTQ_Q7NAME, FASTQ_Q8NAME, FASTQ_Q9NAME, FASTQ_QANAME, FASTQ_QBNAME, FASTQ_QCNAME, FASTQ_QDNAME, FASTQ_QENAME, FASTQ_QmNAME, FASTQ_QNAME2, FASTQ_Q0NAME2, FASTQ_Q1NAME2, FASTQ_Q2NAME2, FASTQ_Q3NAME2, FASTQ_Q4NAME2, FASTQ_Q5NAME2, FASTQ_Q6NAME2, FASTQ_Q7NAME2, FASTQ_Q8NAME2, FASTQ_Q9NAME2, FASTQ_QANAME2, FASTQ_QBNAME2, FASTQ_QCNAME2, FASTQ_QDNAME2, FASTQ_QENAME2, FASTQ_QmNAME2, FASTQ_EXTRA, FASTQ_AUX, FASTQ_SQBITMAP, FASTQ_NONREF, FASTQ_NONREF_X, FASTQ_GPOS, FASTQ_GPOS_DELTA, FASTQ_STRAND, FASTQ_SEQMIS_A, FASTQ_SEQMIS_C, FASTQ_SEQMIS_G, FASTQ_SEQMIS_T, FASTQ_QUAL, FASTQ_DOMQRUNS, FASTQ_QUALMPLX, FASTQ_DIVRQUAL, FASTQ_TOPLEVEL, FASTQ_BUDDY, FASTQ_TAXID, FASTQ_DEBUG_LINES, FASTQ_DEEP, FASTQ_DEEP_DELTA, FASTQ_E1L, FASTQ_E2L, FASTQ_LINE3, FASTQ_T0HIRD, FASTQ_T1HIRD, FASTQ_T2HIRD, FASTQ_T3HIRD, FASTQ_T4HIRD, FASTQ_T5HIRD, FASTQ_T6HIRD, FASTQ_T7HIRD, FASTQ_T8HIRD, FASTQ_T9HIRD, FASTQ_TAHIRD, FASTQ_TBHIRD, FASTQ_TCHIRD, FASTQ_TDHIRD, FASTQ_TEHIRD, FASTQ_TmHIRD, FASTQ_AUX_LENGTH, NUM_FASTQ_FIELDS } FASTQFields;

#define FASTQ_PREDEFINED { \
    [FASTQ_CONTIG] = { { _FASTQ_CONTIG }, TAG(CONTIG) }, \
    [FASTQ_QNAME] = { { _FASTQ_QNAME }, TAG(QNAME) }, \
    ...
    [FASTQ_QCNAME] = { { _FASTQ_QCNAME }, TAG(QCNAME) }, \
    [FASTQ_QDNAME] = { { _FASTQ_QDNAME }, TAG(QDNAME) }, \
    [FASTQ_QENAME] = { { _FASTQ_QENAME }, TAG(QENAME) }, \
    ...
    [FASTQ_QCNAME2] = { { _FASTQ_QCNAME2 }, TAG(qCNAME) }, \
    [FASTQ_QDNAME2] = { { _FASTQ_QDNAME2 }, TAG(qDNAME) }, \
    [FASTQ_QENAME2] = { { _FASTQ_QENAME2 }, TAG(qENAME) }, \
    [FASTQ_QmNAME2] = { { _FASTQ_QmNAME2 }, TAG(qmNAME) }, \
    [FASTQ_EXTRA] = { { _FASTQ_EXTRA }, TAG(DESC) }, \
    [FASTQ_AUX] = { { _FASTQ_AUX }, TAG(AUX) }, \
    ...
    [FASTQ_GPOS_DELTA] = { { _FASTQ_GPOS_DELTA }, TAG(G0POS) }, \
    ...
    [FASTQ_BUDDY] = { { _FASTQ_BUDDY }, TAG(BUDDY) }, \
...
#define MAX_NUM_FIELDS_PER_DATA_TYPE 384
