...
#define _UNUSED_FASTQ_QNAME2 ((uint64_t)55273230257681)
#define _UNUSED_FASTQ_Q0NAME2 ((uint64_t)76198110441713)
#define _UNUSED_FASTQ_Q1NAME2 ((uint64_t)76198110441969)
#define _UNUSED_FASTQ_Q2NAME2 ((uint64_t)76198110442225)
#define _UNUSED_FASTQ_Q3NAME2 ((uint64_t)76198110442481)
#define _UNUSED_FASTQ_Q4NAME2 ((uint64_t)76198110442737)
#define _UNUSED_FASTQ_Q5NAME2 ((uint64_t)76198110442993)
#define _UNUSED_FASTQ_Q6NAME2 ((uint64_t)76198110443249)
#define _UNUSED_FASTQ_Q7NAME2 ((uint64_t)76198110443505)
#define _UNUSED_FASTQ_Q8NAME2 ((uint64_t)76198110443761)
#define _UNUSED_FASTQ_Q9NAME2 ((uint64_t)76198110444017)
#define _UNUSED_FASTQ_QANAME2 ((uint64_t)76198110446065)
#define _UNUSED_FASTQ_QBNAME2 ((uint64_t)76198110446321)
#define _UNUSED_FASTQ_QmNAME2 ((uint64_t)76198110457329)
#define _UNUSED_FASTQ_EXTRA ((uint64_t)1129530820)
...
#define _UNUSED_FASTQ_DEEP_VB ((uint64_t)1346716932)
#define _UNUSED_FASTQ_E1L ((uint64_t)4993285)
#define _UNUSED_FASTQ_E2L ((uint64_t)4993541)
#define _UNUSED_FASTQ_LINE3 ((uint64_t)220206090508)
#define _UNUSED_FASTQ_T0HIRD ((uint64_t)76198110441716)
#define _UNUSED_FASTQ_T1HIRD ((uint64_t)76198110441972)
#define _UNUSED_FASTQ_T2HIRD ((uint64_t)76198110442228)
#define _UNUSED_FASTQ_T3HIRD ((uint64_t)76198110442484)
#define _UNUSED_FASTQ_T4HIRD ((uint64_t)76198110442740)
#define _UNUSED_FASTQ_T5HIRD ((uint64_t)76198110442996)
#define _UNUSED_FASTQ_T6HIRD ((uint64_t)76198110443252)
#define _UNUSED_FASTQ_T7HIRD ((uint64_t)76198110443508)
#define _UNUSED_FASTQ_T8HIRD ((uint64_t)76198110443764)
#define _UNUSED_FASTQ_T9HIRD ((uint64_t)76198110444020)
#define _UNUSED_FASTQ_TAHIRD ((uint64_t)76198110446068)
#define _UNUSED_FASTQ_TBHIRD ((uint64_t)76198110446324)
#define _UNUSED_FASTQ_TmHIRD ((uint64_t)76198110457332)
#define _UNUSED_FASTQ_AUX_LENGTH ((uint64_t)114849160783212)
...
#define SAM_PREDEFINED { \
    ...
    [UNUSED_FASTQ_QNAME2] = { { _UNUSED_FASTQ_QNAME2 }, TAG(QNAME2) }, \
    [UNUSED_FASTQ_Q0NAME2] = { { _UNUSED_FASTQ_Q0NAME2 }, TAG(q0NAME) }, \
    [UNUSED_FASTQ_Q1NAME2] = { { _UNUSED_FASTQ_Q1NAME2 }, TAG(q1NAME) }, \
    [UNUSED_FASTQ_Q2NAME2] = { { _UNUSED_FASTQ_Q2NAME2 }, TAG(q2NAME) }, \
    [UNUSED_FASTQ_Q3NAME2] = { { _UNUSED_FASTQ_Q3NAME2 }, TAG(q3NAME) }, \
    [UNUSED_FASTQ_Q4NAME2] = { { _UNUSED_FASTQ_Q4NAME2 }, TAG(q4NAME) }, \
    [UNUSED_FASTQ_Q5NAME2] = { { _UNUSED_FASTQ_Q5NAME2 }, TAG(q5NAME) }, \
    [UNUSED_FASTQ_Q6NAME2] = { { _UNUSED_FASTQ_Q6NAME2 }, TAG(q6NAME) }, \
    [UNUSED_FASTQ_Q7NAME2] = { { _UNUSED_FASTQ_Q7NAME2 }, TAG(q7NAME) }, \
    [UNUSED_FASTQ_Q8NAME2] = { { _UNUSED_FASTQ_Q8NAME2 }, TAG(q8NAME) }, \
    [UNUSED_FASTQ_Q9NAME2] = { { _UNUSED_FASTQ_Q9NAME2 }, TAG(q9NAME) }, \
    [UNUSED_FASTQ_QANAME2] = { { _UNUSED_FASTQ_QANAME2 }, TAG(qANAME) }, \
    [UNUSED_FASTQ_QBNAME2] = { { _UNUSED_FASTQ_QBNAME2 }, TAG(qBNAME) }, \
    [UNUSED_FASTQ_QmNAME2] = { { _UNUSED_FASTQ_QmNAME2 }, TAG(qmNAME) }, \
    [UNUSED_FASTQ_EXTRA] = { { _UNUSED_FASTQ_EXTRA }, TAG(DESC) }, \
    ...
    [UNUSED_FASTQ_DEEP_VB] = { { _UNUSED_FASTQ_DEEP_VB }, TAG(DEEP) }, \
    [UNUSED_FASTQ_E1L] = { { _UNUSED_FASTQ_E1L }, TAG(E1L) }, \
    [UNUSED_FASTQ_E2L] = { { _UNUSED_FASTQ_E2L }, TAG(E2L) }, \
    [UNUSED_FASTQ_LINE3] = { { _UNUSED_FASTQ_LINE3 }, TAG(LINE3) }, \
    [UNUSED_FASTQ_T0HIRD] = { { _UNUSED_FASTQ_T0HIRD }, TAG(t0NAME) }, \
    [UNUSED_FASTQ_T1HIRD] = { { _UNUSED_FASTQ_T1HIRD }, TAG(t1NAME) }, \
    [UNUSED_FASTQ_T2HIRD] = { { _UNUSED_FASTQ_T2HIRD }, TAG(t2NAME) }, \
    [UNUSED_FASTQ_T3HIRD] = { { _UNUSED_FASTQ_T3HIRD }, TAG(t3NAME) }, \
    [UNUSED_FASTQ_T4HIRD] = { { _UNUSED_FASTQ_T4HIRD }, TAG(t4NAME) }, \
    [UNUSED_FASTQ_T5HIRD] = { { _UNUSED_FASTQ_T5HIRD }, TAG(t5NAME) }, \
    [UNUSED_FASTQ_T6HIRD] = { { _UNUSED_FASTQ_T6HIRD }, TAG(t6NAME) }, \
    [UNUSED_FASTQ_T7HIRD] = { { _UNUSED_FASTQ_T7HIRD }, TAG(t7NAME) }, \
    [UNUSED_FASTQ_T8HIRD] = { { _UNUSED_FASTQ_T8HIRD }, TAG(t8NAME) }, \
    [UNUSED_FASTQ_T9HIRD] = { { _UNUSED_FASTQ_T9HIRD }, TAG(t9NAME) }, \
    [UNUSED_FASTQ_TAHIRD] = { { _UNUSED_FASTQ_TAHIRD }, TAG(tANAME) }, \
    [UNUSED_FASTQ_TBHIRD] = { { _UNUSED_FASTQ_TBHIRD }, TAG(tBNAME) }, \
    [UNUSED_FASTQ_TmHIRD] = { { _UNUSED_FASTQ_TmHIRD }, TAG(tmNAME) }, \
    [UNUSED_FASTQ_AUX_LENGTH] = { { _UNUSED_FASTQ_AUX_LENGTH }, TAG(length) }, \
...
typedef enum { FASTQ_CONTIG, FASTQ_QNAME, FASTQ_Q0NAME, FASTQ_Q1NAME, FASTQ_Q2NAME, FASTQ_Q3NAME, FASTQ_Q4NAME, FASTQ_Q5NAME, FASTQ_Q6NAME, FASTQ_Q7NAME, FASTQ_Q8NAME, FASTQ_Q9NAME, FASTQ_QANAME, FASTQ_QBNAME, FASTQ_QmNAME, FASTQ_QNAME2, FASTQ_Q0NAME2, FASTQ_Q1NAME2, FASTQ_Q2NAME2, FASTQ_Q3NAME2, FASTQ_Q4NAME2, FASTQ_Q5NAME2, FASTQ_Q6NAME2, FASTQ_Q7NAME2, FASTQ_Q8NAME2, FASTQ_Q9NAME2, FASTQ_QANAME2, FASTQ_QBNAME2, FASTQ_QmNAME2, FASTQ_EXTRA, FASTQ_AUX, FASTQ_SQBITMAP, FASTQ_NONREF, FASTQ_NONREF_X, FASTQ_GPOS, FASTQ_STRAND, FASTQ_SEQMIS_A, FASTQ_SEQMIS_C, FASTQ_SEQMIS_G, FASTQ_SEQMIS_T, FASTQ_QUAL, FASTQ_DOMQRUNS, FASTQ_QUALMPLX, FASTQ_DIVRQUAL, FASTQ_TOPLEVEL, FASTQ_BUDDY, FASTQ_TAXID, FASTQ_DEBUG_LINES, FASTQ_DEEP, FASTQ_E1L, FASTQ_E2L, FASTQ_LINE3, FASTQ_T0HIRD, FASTQ_T1HIRD, FASTQ_T2HIRD, FASTQ_T3HIRD, FASTQ_T4HIRD, FASTQ_T5HIRD, FASTQ_T6HIRD, FASTQ_T7HIRD, FASTQ_T8HIRD, FASTQ_T9HIRD, FASTQ_TAHIRD, FASTQ_TBHIRD, FASTQ_TmHIRD, FASTQ_AUX_LENGTH, NUM_FASTQ_FIELDS } FASTQFields;
...
#define MAX_NUM_FIELDS_PER_DATA_TYPE 352
