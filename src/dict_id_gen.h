...
#define _SAM_FQ_AUX ((uint64_t)1516192525)
...
#define SAM_PREDEFINED { \
    ...
    [SAM_FQ_AUX] = { { _SAM_FQ_AUX }, TAG(MC_Z) }, \
...
#define MAX_NUM_FIELDS_PER_DATA_TYPE 350
