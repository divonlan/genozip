...
#define decl_smux_ctxs_zip(id)                                                                                                                  \
    ContextP ctxs[5] = { ctx_get_ctx (vb, (DictId)DICT_ID_MAKEF_L(((char[]){'A','A','A','-',(id[0] & 0x7f) | 0x40, id[1], id[2], id[3], 0}))),  \
                         ctx_get_ctx (vb, (DictId)DICT_ID_MAKEF_L(((char[]){'C','C','C','-',(id[0] & 0x7f) | 0x40, id[1], id[2], id[3], 0}))),  \
                         ctx_get_ctx (vb, (DictId)DICT_ID_MAKEF_L(((char[]){'G','G','G','-',(id[0] & 0x7f) | 0x40, id[1], id[2], id[3], 0}))),  \
                         ctx_get_ctx (vb, (DictId)DICT_ID_MAKEF_L(((char[]){'T','T','T','-',(id[0] & 0x7f) | 0x40, id[1], id[2], id[3], 0}))),  \
                         ctx_get_ctx (vb, (DictId)DICT_ID_MAKEF_L(((char[]){'N','N','N','-',(id[0] & 0x7f) | 0x40, id[1], id[2], id[3], 0}))) }; // N and other IUPACs

#define decl_smux_ctxs_piz(id)                                                                                                                  \
    ContextP ctxs[5] = { ECTX((DictId)DICT_ID_MAKEF_L(((char[]){'A','A','A','-',(id[0] & 0x7f) | 0x40, id[1], id[2], id[3], 0}))),              \
                         ECTX((DictId)DICT_ID_MAKEF_L(((char[]){'C','C','C','-',(id[0] & 0x7f) | 0x40, id[1], id[2], id[3], 0}))),              \
                         ECTX((DictId)DICT_ID_MAKEF_L(((char[]){'G','G','G','-',(id[0] & 0x7f) | 0x40, id[1], id[2], id[3], 0}))),              \
                         ECTX((DictId)DICT_ID_MAKEF_L(((char[]){'T','T','T','-',(id[0] & 0x7f) | 0x40, id[1], id[2], id[3], 0}))),              \
                         ECTX((DictId)DICT_ID_MAKEF_L(((char[]){'N','N','N','-',(id[0] & 0x7f) | 0x40, id[1], id[2], id[3], 0}))) }; // NULL if not data for this base
