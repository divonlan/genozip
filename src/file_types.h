...
typedef enum FileType { UNKNOWN_FILE_TYPE, 
                        REF_GENOZIP,
                        ...
                        FSA,   FSA_GZ,   FSA_BZ2,   FSA_XZ,       FSA_GENOZIP,
...
#define FILE_EXTS {"Unknown", /* order matches the FileType enum */                                             \
                   ...
                   FSA_,      FSA_GZ_,            FSA_BZ2_,    FSA_XZ_,                 FSA_GENOZIP_,           \
...
#define TXT_IN_FT_BY_DT  { { { FASTA,      CODEC_NONE, REF_GENOZIP    }, { FASTA_GZ,  CODEC_GZ,  REF_GENOZIP    }, /* fasta for generating reference files */\
                           ...
                           { { FASTA,      CODEC_NONE, FASTA_GENOZIP  }, { FASTA_GZ,  CODEC_GZ,  FASTA_GENOZIP  },\
                             ...
                             { FSA_BZ2,    CODEC_BZ2,  FSA_GENOZIP    }, { FSA_XZ,    CODEC_XZ,  FSA_GENOZIP    },\
...
#define Z_FT_BY_DT { { REF_GENOZIP, 0  },                   \
                     ...
                     { FASTA_GENOZIP, FA_GENOZIP, FAA_GENOZIP, FFN_GENOZIP, FNN_GENOZIP, FNA_GENOZIP, FRN_GENOZIP, FAS_GENOZIP, FSA_GENOZIP, 0 }, \
