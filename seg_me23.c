                                ...
                                const char *field_start_line)     // index in vb->txt_data where this line starts
{
    ...
    vb->last_pos = seg_pos_field (vb_, vb->last_pos, NULL, false, ME23_POS, SEC_POS_B250, field_start, field_len, "POS");
    ...
    seg_add_to_fixed_buf (vb_, &vb->genotype_data, SEC_HT_DATA, field_start, 2, field_len + 1 + has_13); 
