...
int main (int argc, char **argv)
{
    ...
    while (1) {
        ...
        #define _24 {"encode-24",     no_argument,       &flag_encode_24,    1 }  
        #define _00 {0, 0, 0, 0                                                }
    ...
    ASSERT (!flag_encode_8 || !flag_encode_24,  "%s: options --encode-8 and --encode-24 are mutually exclusive", global_cmd);
    ASSERT (!flag_encode_16 || !flag_encode_24, "%s: options --encode-16 and --encode-24 are mutually exclusive", global_cmd);
